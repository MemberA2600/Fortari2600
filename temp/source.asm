...
*Picture Data*
**************
Bank2_Picture64px_Picture64px_Elzevir_Logo_picIndex = counter
Bank2_Picture64px_Picture64px_Elzevir_Logo_picDisplayHeight = #27
Bank2_Picture64px_Picture64px_Elzevir_Logo_picHeight = 27
**************************

	LDA	#Bank2_Picture64px_Picture64px_Elzevir_Logo_picHeight
	

	LDA	#0
	STA	Bank2_Picture64px_Picture64px_Elzevir_Logo_picIndex
