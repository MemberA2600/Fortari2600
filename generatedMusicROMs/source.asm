...
kossuth_-_lajos_Pointer0 = $e2
kossuth_-_lajos_Duration0 = $e4
kossuth_-_lajos_Pointer1 = $e5
kossuth_-_lajos_Duration1 = $e7
kossuth_-_lajos_PointerBackUp0 = $e8
kossuth_-_lajos_PointerBackUp1 = $ea


kossuth_-_lajos_Init
	LDA	#1
	STA	kossuth_-_lajos_Duration0
	STA	kossuth_-_lajos_Duration1

	LDA	#<kossuth_-_lajos_Data0
	STA	kossuth_-_lajos_Pointer0
	LDA	#>kossuth_-_lajos_Data0
	STA	kossuth_-_lajos_Pointer0+1

	LDA	#<kossuth_-_lajos_Data1
	STA	kossuth_-_lajos_Pointer1
	LDA	#>kossuth_-_lajos_Data1
	STA	kossuth_-_lajos_Pointer1+1
...
kossuth_-_lajos_Move_text

	LDA	#TextEnd 
	CMP	#0
	BEQ	kossuth_-_lajos_Move_Ended

	LDA	counter
	AND	#%00011111
	CMP	#%00011111

	BNE	kossuth_-_lajos_Move_Ended

	LDA	TextDir
	CMP	#0
	BNE	kossuth_-_lajos_Text_Reversed

	LDA	TextPoz
	CMP	#TextEnd
	BCC	kossuth_-_lajos_INCR

	LDA	#1
	STA	TextDir
	JMP	kossuth_-_lajos_DECR	
kossuth_-_lajos_INCR
	INC	TextPoz
	JMP	kossuth_-_lajos_Move_Ended

kossuth_-_lajos_Text_Reversed
	LDA	TextPoz
	CMP	#0
	BNE	kossuth_-_lajos_DECR
	STA	TextDir
	JMP	kossuth_-_lajos_INCR
kossuth_-_lajos_DECR
	DEC	TextPoz
kossuth_-_lajos_Move_Ended

	LDY	TextPoz
	LDX	#255

kossuth_-_lajos_Text_Create_Loop
	INX
	CPX	#12
	BEQ	kossuth_-_lajos_Text_Create_End

	LDA	kossuth_-_lajos_ReallyNiceText,y
	STA	Letter01,x
	INY
	JMP	kossuth_-_lajos_Text_Create_Loop

kossuth_-_lajos_Text_Create_End
	LDA	#56
	CMP	picDisplayHeight
	BCS	kossuth_-_lajos_DontCutHeight
	STA	picDisplayHeight
kossuth_-_lajos_DontCutHeight
	LDA	#2
	asl
	...
	lda	#<(kossuth_-_lajos_JumpBack-1)
	sta	temp01
   	lda	#>(kossuth_-_lajos_JumpBack-1)
	sta	temp02

	lda	#>(kossuth_-_lajos_Driver0-1)
   	pha
   	lda	#<(kossuth_-_lajos_Driver0-1)
   	pha
   	pha
...
kossuth_-_lajos_DynamicText_Begin
	...
	AND	#%00000001		; 2 
	CMP	#%00000001		; 2 		
	BEQ	kossuth_-_lajos_DynamicText_Otherjump	; 2 
	JMP	kossuth_-_lajos_DynamicText_Even_Begin	; 3 
kossuth_-_lajos_DynamicText_Otherjump
	JMP	kossuth_-_lajos_DynamicText_Odd_Begin	; 3 
	
	_align	250

kossuth_-_lajos_DynamicText_Odd_Begin
...
kossuth_-_lajos_DynamicText_Odd_Line0
	STA	WSYNC				; 76
	STY	COLUBK
...
kossuth_-_lajos_DynamicText_Odd_Line1
	STA	WSYNC				; 76
	LDY	Letter03				; 3
...
kossuth_-_lajos_DynamicText_Odd_Line2
	STA	WSYNC				; 76
	LDY	Letter01				; 3
...
kossuth_-_lajos_DynamicText_Odd_Line3
	STA	WSYNC				; 76
	LDY	Letter03				; 3
...
kossuth_-_lajos_DynamicText_Odd_Line2
	...
	JMP	kossuth_-_lajos_DynamicText_Reset

	_align	250

kossuth_-_lajos_DynamicText_Even_Begin
	LDY	Letter11				; 3 
...
kossuth_-_lajos_DynamicText_Even_Line0
	STA	WSYNC				; 76
	STY	COLUBK				; 3
...
kossuth_-_lajos_DynamicText_Even_Line1
	STA	WSYNC				; 76
	LDY	Letter01				; 3
	LDA	Bank2Font_Right_Line3,y	; 4 (7)
	LDY	Letter02				; 3 (10)
...
kossuth_-_lajos_DynamicText_Even_Line2
	STA	WSYNC				; 76
	LDY	Letter03				; 3
	LDA	Bank2Font_Right_Line2,y	; 4 (7)
	LDY	Letter04				; 3 (10)
...
kossuth_-_lajos_DynamicText_Even_Line3
	STA	WSYNC				; 76
	LDY	Letter01				; 3
	LDA	Bank2Font_Right_Line1,y	; 4 (8)
	LDY	Letter02				; 3 (11)
...
kossuth_-_lajos_DynamicText_Even_Line4
	STA	WSYNC				; 76
	LDY	Letter03				; 3
	LDA	Bank2Font_Right_Line0,y	; 4 (7)
	LDY	Letter04				; 3 (10)
...
kossuth_-_lajos_DynamicText_Reset
	LDX	#0			; 2
	STX	GRP1			; 3 
	STX	GRP0			; 3
...
MusicIndicator8 = $ce
	...
	AND	#%00000011
	CMP	#%00000011
	BEQ	kossuth_-_lajos_Visuals_DECR
	
	_sleep	34
	sleep	3
	JMP	kossuth_-_lajos_Visuals_NoLSR

kossuth_-_lajos_Visuals_DECR
	LSR	MusicIndicator1
	LSR	MusicIndicator2
	LSR	MusicIndicator3
	LSR	MusicIndicator4
...
*
	...
	LDA	kossuth_-_lajos_Visuals_Data_Pointers,y
	CMP	#0
	BEQ	kossuth_-_lajos_Visuals_NoChangeChannel0
	...
	BCC	kossuth_-_lajos_Visuals_NoChangeChannel0
	STA	MusicIndicator1,x

kossuth_-_lajos_Visuals_NoChangeChannel0
	STA	WSYNC
	...
	LDA	kossuth_-_lajos_Visuals_Data_Pointers,y
	CMP	#0
	BEQ	kossuth_-_lajos_Visuals_NoChangeChannel1
	...
	LDA	temp03
	CMP	MusicIndicator1,x
	BCC	kossuth_-_lajos_Visuals_NoChangeChannel1
	STA	MusicIndicator1,x

kossuth_-_lajos_Visuals_NoChangeChannel1
	JMP	kossuth_-_lajos_Visuals_Display

kossuth_-_lajos_Visuals_Data

kossuth_-_lajos_Visuals_Data_Pointers
	BYTE	#0
	BYTE	#0				; 0
	BYTE	#<kossuth_-_lajos_Visuals_Data_Channel_1
	BYTE	#>kossuth_-_lajos_Visuals_Data_Channel_1	; 1
	BYTE	#<kossuth_-_lajos_Visuals_Data_Channel_6
	BYTE	#>kossuth_-_lajos_Visuals_Data_Channel_6	; 2
	BYTE	#<kossuth_-_lajos_Visuals_Data_Channel_6
	BYTE	#>kossuth_-_lajos_Visuals_Data_Channel_6	; 3	
	BYTE	#<kossuth_-_lajos_Visuals_Data_Channel_4
	BYTE	#>kossuth_-_lajos_Visuals_Data_Channel_4	; 4
	BYTE	#<kossuth_-_lajos_Visuals_Data_Channel_6
	BYTE	#>kossuth_-_lajos_Visuals_Data_Channel_6	; 6
	BYTE	#<kossuth_-_lajos_Visuals_Data_Channel_6
	BYTE	#>kossuth_-_lajos_Visuals_Data_Channel_6	; 6
	BYTE	#<kossuth_-_lajos_Visuals_Data_Channel_6
	BYTE	#>kossuth_-_lajos_Visuals_Data_Channel_6	; 7
	BYTE	#<kossuth_-_lajos_Visuals_Data_Channel_6
	BYTE	#>kossuth_-_lajos_Visuals_Data_Channel_6	; 8
	BYTE	#<kossuth_-_lajos_Visuals_Data_Channel_6
	BYTE	#>kossuth_-_lajos_Visuals_Data_Channel_6	; 9
	BYTE	#<kossuth_-_lajos_Visuals_Data_Channel_6
	BYTE	#>kossuth_-_lajos_Visuals_Data_Channel_6	; 10
	BYTE	#<kossuth_-_lajos_Visuals_Data_Channel_6
	BYTE	#>kossuth_-_lajos_Visuals_Data_Channel_6	; 11
	BYTE	#<kossuth_-_lajos_Visuals_Data_Channel_12
	BYTE	#>kossuth_-_lajos_Visuals_Data_Channel_12	; 12
	BYTE	#<kossuth_-_lajos_Visuals_Data_Channel_6
	BYTE	#>kossuth_-_lajos_Visuals_Data_Channel_6	; 13
	BYTE	#<kossuth_-_lajos_Visuals_Data_Channel_6
	BYTE	#>kossuth_-_lajos_Visuals_Data_Channel_6	; 14
	BYTE	#<kossuth_-_lajos_Visuals_Data_Channel_6
	BYTE	#>kossuth_-_lajos_Visuals_Data_Channel_6	; 15

kossuth_-_lajos_Visuals_Data_Channel_1
	BYTE	#0
	BYTE	#2
	BYTE	#4
	BYTE	#5
	...
	BYTE	#7
	BYTE	#7
kossuth_-_lajos_Visuals_Data_Channel_4
	BYTE	#0
	BYTE	#0
	BYTE	#0
	BYTE	#0
	...
	BYTE	#5
	BYTE	#5
kossuth_-_lajos_Visuals_Data_Channel_6
	BYTE	#2
	BYTE	#5
	BYTE	#6
	BYTE	#6
	...
	BYTE	#7
	BYTE	#7
kossuth_-_lajos_Visuals_Data_Channel_12
	BYTE	#0
	BYTE	#0
	BYTE	#0
	BYTE	#0
...
kossuth_-_lajos_Visuals_Data_Bars
	BYTE	#%00000000
	BYTE	#%10000000
	BYTE	#%11000000
	BYTE	#%11100000
...
kossuth_-_lajos_Visuals_Data_Barcolors
	BYTE	#$18
	BYTE	#$16
	BYTE	#$14
	BYTE	#$38
	...
	align	256
kossuth_-_lajos_Visuals_Display
	LDX	#0
kossuth_-_lajos_Visuals_LineLoop
	STA	WSYNC	; 76
	LDA	MusicIndicator1,x		; 5
	lsr					; 2 (7)
	TAY					; 2 (9)
	STA	temp04				; 3 (12)
	LDA	kossuth_-_lajos_Visuals_Data_Bars,y	; 5 (17)
	STA	PF2				; 3 (20)
	...
	CLC					; 2 (31)
	ADC 	kossuth_-_lajos_Visuals_Data_Barcolors,y	; 5 (36)
	STA	COLUPF				; 3 (39)
	STA	temp03				; 3 (42)

	LDY	#3	; This is the line num!
kossuth_-_lajos_Visuals_LineFiller
	STA	WSYNC
	DEC 	temp03
	...
	AND	#%00001111
	CMP	#$04
	BCC	kossuth_-_lajos_Visuals_NoColorDECR
	DEC	temp03
kossuth_-_lajos_Visuals_NoColorDECR
	LDA	temp03

	STA	COLUPF

	DEY
	BPL	kossuth_-_lajos_Visuals_LineFiller
	STA	WSYNC
	LDA	frameColor
	STA	COLUPF
	...
	INX	
	CPX	#8
	BNE	kossuth_-_lajos_Visuals_LineLoop

kossuth_-_lajos_Visuals_DisplayEnded
	LDA	#0
	STA	ENAM0
	STA	HMCLR
...
kossuth_-_lajos_ReallyNiceText
	BYTE	#20
	BYTE	#25
	BYTE	#29
	BYTE	#29
...
***************************
	Bank 3
	fill	256
kossuth_-_lajos_Driver0
	DEC	kossuth_-_lajos_Duration0
	LDA	kossuth_-_lajos_Duration0
	CMP	#0
	BNE	kossuth_-_lajos_Skip0

kossuth_-_lajos_ReadFirst0
	LDX	#kossuth_-_lajos_Pointer0
	LDA	($00,x)
	INC	0,x
	BNE	*+4
	INC	1,x
	...
	STA	temp16
	STA	temp17
	JMP	kossuth_-_lajos_NotSharedByte0

kossuth_-_lajos_if2400
	CMP	#240
	BNE	kossuth_-_lajos_NoRestart0

kossuth_-_lajos_Restart0
	LDA	#<kossuth_-_lajos_Data0
	STA	kossuth_-_lajos_Pointer0
	LDA	#>kossuth_-_lajos_Data0
	STA	kossuth_-_lajos_Pointer0+1
	...
	JMP	kossuth_-_lajos_ReadFirst0

kossuth_-_lajos_NoRestart0
	STA	temp06
	AND	#%00001111
	CMP	#0
	BNE	kossuth_-_lajos_CommonNote0
	LDA	temp06
	lsr
	lsr
	lsr
	lsr
	CMP	#%00001110
	BNE	kossuth_-_lajos_NoRestorePointer0
	LDA	kossuth_-_lajos_PointerBackUp0
	STA	kossuth_-_lajos_Pointer0
	LDA	kossuth_-_lajos_PointerBackUp0+1
	STA	kossuth_-_lajos_Pointer0+1
	JMP	kossuth_-_lajos_ReadFirst0
kossuth_-_lajos_NoRestorePointer0
	
	LDY	kossuth_-_lajos_Pointer0	
	STY	kossuth_-_lajos_PointerBackUp0	
	LDY	kossuth_-_lajos_Pointer0+1
	STY	kossuth_-_lajos_PointerBackUp0+1	

	ASL
	TAX
	LDA	kossuth_-_lajos_Data0_CompressedPointerTable,x
	STA	kossuth_-_lajos_Pointer0
	LDA	kossuth_-_lajos_Data0_CompressedPointerTable+1,x
	STA	kossuth_-_lajos_Pointer0+1
	JMP	kossuth_-_lajos_ReadFirst0

kossuth_-_lajos_CommonNote0
	LDA	temp06
	STA	AUDV0
	STA	temp16
	lsr
	...
	CMP	#32
	BCC	kossuth_-_lajos_NotSharedByte0
	...
	STA	kossuth_-_lajos_Duration0
	JMP	kossuth_-_lajos_Skip0

kossuth_-_lajos_NotSharedByte0
...
kossuth_-_lajos_Skip0
kossuth_-_lajos_Driver1
	DEC	kossuth_-_lajos_Duration1
	LDA	kossuth_-_lajos_Duration1
	CMP	#0
	BNE	kossuth_-_lajos_Skip1

kossuth_-_lajos_ReadFirst1
	LDX	#kossuth_-_lajos_Pointer1
	LDA	($00,x)
	INC	0,x
	BNE	*+4
	INC	1,x
	...
	STA	temp18
	STA	temp19
	JMP	kossuth_-_lajos_NotSharedByte1

kossuth_-_lajos_if2401
	CMP	#240
	BNE	kossuth_-_lajos_NoRestart1

kossuth_-_lajos_Restart1
	LDA	#<kossuth_-_lajos_Data0
	STA	kossuth_-_lajos_Pointer0
	LDA	#>kossuth_-_lajos_Data0
	STA	kossuth_-_lajos_Pointer0+1
	...
	JMP	kossuth_-_lajos_ReadFirst1

kossuth_-_lajos_NoRestart1
	STA	temp06
	AND	#%00001111
	CMP	#0
	BNE	kossuth_-_lajos_CommonNote1
	LDA	temp06
	lsr
	lsr
	lsr
	lsr
	CMP	#%00001110
	BNE	kossuth_-_lajos_NoRestorePointer1
	LDA	kossuth_-_lajos_PointerBackUp1
	STA	kossuth_-_lajos_Pointer1
	LDA	kossuth_-_lajos_PointerBackUp1+1
	STA	kossuth_-_lajos_Pointer1+1
	JMP	kossuth_-_lajos_ReadFirst1
kossuth_-_lajos_NoRestorePointer1
	
	LDY	kossuth_-_lajos_Pointer1	
	STY	kossuth_-_lajos_PointerBackUp1	
	LDY	kossuth_-_lajos_Pointer1+1
	STY	kossuth_-_lajos_PointerBackUp1+1	

	ASL
	TAX
	LDA	kossuth_-_lajos_Data1_CompressedPointerTable,x
	STA	kossuth_-_lajos_Pointer1
	LDA	kossuth_-_lajos_Data1_CompressedPointerTable+1,x
	STA	kossuth_-_lajos_Pointer1+1
	JMP	kossuth_-_lajos_ReadFirst1

kossuth_-_lajos_CommonNote1
	LDA	temp06
	STA	AUDV1
	STA	temp18
	lsr
	...
	CMP	#32
	BCC	kossuth_-_lajos_NotSharedByte1
	...
	STA	kossuth_-_lajos_Duration1
	JMP	kossuth_-_lajos_Skip1

kossuth_-_lajos_NotSharedByte1
...
kossuth_-_lajos_Skip1
	...
	lda	temp02
   	...
   	pha
	jmp	bankSwitchJump
kossuth_-_lajos_Data0_CompressedPointerTable
	BYTE	#0
	BYTE	#0
	BYTE	#<kossuth_-_lajos_Channel0_00010000
	BYTE	#>kossuth_-_lajos_Channel0_00010000
	BYTE	#<kossuth_-_lajos_Channel0_00100000
	BYTE	#>kossuth_-_lajos_Channel0_00100000
	BYTE	#<kossuth_-_lajos_Channel0_00110000
	BYTE	#>kossuth_-_lajos_Channel0_00110000
	BYTE	#<kossuth_-_lajos_Channel0_01000000
	BYTE	#>kossuth_-_lajos_Channel0_01000000
	BYTE	#<kossuth_-_lajos_Channel0_01010000
	BYTE	#>kossuth_-_lajos_Channel0_01010000
	BYTE	#<kossuth_-_lajos_Channel0_01100000
	BYTE	#>kossuth_-_lajos_Channel0_01100000
	BYTE	#<kossuth_-_lajos_Channel0_01110000
	BYTE	#>kossuth_-_lajos_Channel0_01110000
	BYTE	#<kossuth_-_lajos_Channel0_10000000
	BYTE	#>kossuth_-_lajos_Channel0_10000000
	BYTE	#<kossuth_-_lajos_Channel0_10010000
	BYTE	#>kossuth_-_lajos_Channel0_10010000
	BYTE	#<kossuth_-_lajos_Channel0_10100000
	BYTE	#>kossuth_-_lajos_Channel0_10100000
	BYTE	#0
	BYTE	#0
	BYTE	#0
...
kossuth_-_lajos_Channel0_00010000
	BYTE	#%11001001
	BYTE	#%00101010
	BYTE	#%11001001
	BYTE	#%00101011
...
kossuth_-_lajos_Channel0_00100000
	BYTE	#%11001001
	BYTE	#%00101010
	BYTE	#%11100000

kossuth_-_lajos_Channel0_00110000
	BYTE	#%11001001
	BYTE	#%00101100
	BYTE	#%11100000

kossuth_-_lajos_Channel0_01000000
	BYTE	#%11001001
	BYTE	#%01101011
	BYTE	#%11100000

kossuth_-_lajos_Channel0_01010000
	BYTE	#%11001001
	BYTE	#%01010010
	BYTE	#%11100000

kossuth_-_lajos_Channel0_01100000
	BYTE	#%11001001
	BYTE	#%01101110
	BYTE	#%11100000

kossuth_-_lajos_Channel0_01110000
	BYTE	#%11001001
	BYTE	#%01110001
	BYTE	#%11100000

kossuth_-_lajos_Channel0_10000000
	BYTE	#%11001001
	BYTE	#%01101111
	BYTE	#%11100000

kossuth_-_lajos_Channel0_10010000
	BYTE	#%11001001
	BYTE	#%01010111
	BYTE	#%11100000

kossuth_-_lajos_Channel0_10100000
	BYTE	#%11001001
	BYTE	#%01011000
	BYTE	#%11100000


kossuth_-_lajos_Data0
	BYTE	#%11001001
	BYTE	#%01101110
...
kossuth_-_lajos_Data1_CompressedPointerTable
	BYTE	#0
	BYTE	#0
	BYTE	#<kossuth_-_lajos_Channel1_00010000
	BYTE	#>kossuth_-_lajos_Channel1_00010000
	BYTE	#<kossuth_-_lajos_Channel1_00100000
	BYTE	#>kossuth_-_lajos_Channel1_00100000
	BYTE	#0
	BYTE	#0
	BYTE	#0
...
kossuth_-_lajos_Channel1_00010000
	BYTE	#%11001001
	BYTE	#%01101011
	BYTE	#%11001001
	BYTE	#%01010010
...
kossuth_-_lajos_Channel1_00100000
	BYTE	#%11001001
	BYTE	#%01101011
	BYTE	#%11100000


kossuth_-_lajos_Data1
	BYTE	#%00000000
	BYTE	#%01100000
	BYTE	#%11001001
	BYTE	#%01011011
