...
M_-_Monkey_Island_Pointer0 = $e2
M_-_Monkey_Island_Duration0 = $e4
M_-_Monkey_Island_Pointer1 = $e5
M_-_Monkey_Island_Duration1 = $e7
M_-_Monkey_Island_PointerBackUp0 = $e8
M_-_Monkey_Island_PointerBackUp1 = $ea


M_-_Monkey_Island_Init
	LDA	#1
	STA	M_-_Monkey_Island_Duration0
	STA	M_-_Monkey_Island_Duration1

	LDA	#<M_-_Monkey_Island_Data0
	STA	M_-_Monkey_Island_Pointer0
	LDA	#>M_-_Monkey_Island_Data0
	STA	M_-_Monkey_Island_Pointer0+1

	LDA	#<M_-_Monkey_Island_Data1
	STA	M_-_Monkey_Island_Pointer1
	LDA	#>M_-_Monkey_Island_Data1
	STA	M_-_Monkey_Island_Pointer1+1
...
M_-_Monkey_Island_Move_text

	LDA	#TextEnd 
	CMP	#0
	BEQ	M_-_Monkey_Island_Move_Ended

	LDA	counter
	AND	#%00011111
	CMP	#%00011111

	BNE	M_-_Monkey_Island_Move_Ended

	LDA	TextDir
	CMP	#0
	BNE	M_-_Monkey_Island_Text_Reversed

	LDA	TextPoz
	CMP	#TextEnd
	BCC	M_-_Monkey_Island_INCR

	LDA	#1
	STA	TextDir
	JMP	M_-_Monkey_Island_DECR	
M_-_Monkey_Island_INCR
	INC	TextPoz
	JMP	M_-_Monkey_Island_Move_Ended

M_-_Monkey_Island_Text_Reversed
	LDA	TextPoz
	CMP	#0
	BNE	M_-_Monkey_Island_DECR
	STA	TextDir
	JMP	M_-_Monkey_Island_INCR
M_-_Monkey_Island_DECR
	DEC	TextPoz
M_-_Monkey_Island_Move_Ended

	LDY	TextPoz
	LDX	#255

M_-_Monkey_Island_Text_Create_Loop
	INX
	CPX	#12
	BEQ	M_-_Monkey_Island_Text_Create_End

	LDA	M_-_Monkey_Island_ReallyNiceText,y
	STA	Letter01,x
	INY
	JMP	M_-_Monkey_Island_Text_Create_Loop

M_-_Monkey_Island_Text_Create_End
	LDA	#56
	CMP	picDisplayHeight
	BCS	M_-_Monkey_Island_DontCutHeight
	STA	picDisplayHeight
M_-_Monkey_Island_DontCutHeight
	LDA	#2
	asl
	...
	lda	#<(M_-_Monkey_Island_JumpBack-1)
	sta	temp01
   	lda	#>(M_-_Monkey_Island_JumpBack-1)
	sta	temp02

	lda	#>(M_-_Monkey_Island_Driver0-1)
   	pha
   	lda	#<(M_-_Monkey_Island_Driver0-1)
   	pha
   	pha
...
M_-_Monkey_IslandPrepareForDarkness
	LDA	TextBackColor	
	STA	WSYNC
	STA	HMOVE		; 3	
	STA	COLUBK		; 3 (6)
...
M_-_Monkey_IslandFillerLine1
	LDA	counter	
	AND	#%00000010
	CMP	#%00000010
	BEQ	M_-_Monkey_IslandCalculateDataStart
	STA	WSYNC
	STA	WSYNC

M_-_Monkey_IslandCalculateDataStart
	STA	WSYNC
	LDX	#0
M_-_Monkey_IslandResetGRP
	STX	GRP0
	STX	GRP1
...
M_-_Monkey_IslandCalculateData
	TYA
	EOR	counter		  	; Seems like the best way to decide
	AND	#%00000001		; which lines to draw.
	CMP	#%00000001
	BEQ	M_-_Monkey_IslandEvenLine

M_-_Monkey_IslandOddLine
	LDA	Letter01
	TAX
	...
	JMP	M_-_Monkey_IslandThisLineIsCalculated	
M_-_Monkey_IslandEvenLine
	LDA	Letter02
	TAX
	LDA	Bank25Table,x		; Got the starting address
	CLC
...
M_-_Monkey_IslandThisLineIsCalculated	
	LDA	TextColor
	ADC	Bank2Colors,y
	STA	COLUP0
	STA	COLUP1
	...
	BIT	temp08
	BPL	M_-_Monkey_IslandNoReColor
	STA	COLUPF
M_-_Monkey_IslandNoReColor
	...
	DEC	temp02		; 5
	LDY	temp02		; 3
	BMI	M_-_Monkey_IslandFillerLine2	; 2 
	JMP	M_-_Monkey_IslandCalculateDataStart   ; 3

M_-_Monkey_IslandFillerLine2
	LDA	#0
	STA	GRP0
	STA	GRP1
	STA 	ENABL		
	...
	AND	#%00000010
	CMP	#%00000010
	BNE	M_-_Monkey_IslandReset
	STA	WSYNC
	STA	WSYNC

M_-_Monkey_IslandReset
M_-_Monkey_Island_Visuals
...
MusicIndicator8 = $ce
	...
	AND	#%00000011
	CMP	#%00000011
	BEQ	M_-_Monkey_Island_Visuals_DECR
	
	_sleep	34
	sleep	3
	JMP	M_-_Monkey_Island_Visuals_NoLSR

M_-_Monkey_Island_Visuals_DECR
	LSR	MusicIndicator1
	LSR	MusicIndicator2
	LSR	MusicIndicator3
	LSR	MusicIndicator4
...
M_-_Monkey_Island_Visuals_NoLSR
	LDA	#$10
	STA	HMM0
...
*
	...
	LDA	M_-_Monkey_Island_Visuals_Data_Pointers,y
	CMP	#0
	BEQ	M_-_Monkey_Island_Visuals_NoChangeChannel0
	...
	BCC	M_-_Monkey_Island_Visuals_NoChangeChannel0
	STA	MusicIndicator1,x

M_-_Monkey_Island_Visuals_NoChangeChannel0
	STA	WSYNC
	...
	LDA	M_-_Monkey_Island_Visuals_Data_Pointers,y
	CMP	#0
	BEQ	M_-_Monkey_Island_Visuals_NoChangeChannel1
	...
	LDA	temp03
	CMP	MusicIndicator1,x
	BCC	M_-_Monkey_Island_Visuals_NoChangeChannel1
	STA	MusicIndicator1,x

M_-_Monkey_Island_Visuals_NoChangeChannel1
	JMP	M_-_Monkey_Island_Visuals_Display

M_-_Monkey_Island_Visuals_Data

M_-_Monkey_Island_Visuals_Data_Pointers
	BYTE	#0
	BYTE	#0				; 0
	BYTE	#<M_-_Monkey_Island_Visuals_Data_Channel_1
	BYTE	#>M_-_Monkey_Island_Visuals_Data_Channel_1	; 1
	BYTE	#<M_-_Monkey_Island_Visuals_Data_Channel_6
	BYTE	#>M_-_Monkey_Island_Visuals_Data_Channel_6	; 2
	BYTE	#<M_-_Monkey_Island_Visuals_Data_Channel_6
	BYTE	#>M_-_Monkey_Island_Visuals_Data_Channel_6	; 3	
	BYTE	#<M_-_Monkey_Island_Visuals_Data_Channel_4
	BYTE	#>M_-_Monkey_Island_Visuals_Data_Channel_4	; 4
	BYTE	#<M_-_Monkey_Island_Visuals_Data_Channel_6
	BYTE	#>M_-_Monkey_Island_Visuals_Data_Channel_6	; 6
	BYTE	#<M_-_Monkey_Island_Visuals_Data_Channel_6
	BYTE	#>M_-_Monkey_Island_Visuals_Data_Channel_6	; 6
	BYTE	#<M_-_Monkey_Island_Visuals_Data_Channel_6
	BYTE	#>M_-_Monkey_Island_Visuals_Data_Channel_6	; 7
	BYTE	#<M_-_Monkey_Island_Visuals_Data_Channel_6
	BYTE	#>M_-_Monkey_Island_Visuals_Data_Channel_6	; 8
	BYTE	#<M_-_Monkey_Island_Visuals_Data_Channel_6
	BYTE	#>M_-_Monkey_Island_Visuals_Data_Channel_6	; 9
	BYTE	#<M_-_Monkey_Island_Visuals_Data_Channel_6
	BYTE	#>M_-_Monkey_Island_Visuals_Data_Channel_6	; 10
	BYTE	#<M_-_Monkey_Island_Visuals_Data_Channel_6
	BYTE	#>M_-_Monkey_Island_Visuals_Data_Channel_6	; 11
	BYTE	#<M_-_Monkey_Island_Visuals_Data_Channel_12
	BYTE	#>M_-_Monkey_Island_Visuals_Data_Channel_12	; 12
	BYTE	#<M_-_Monkey_Island_Visuals_Data_Channel_6
	BYTE	#>M_-_Monkey_Island_Visuals_Data_Channel_6	; 13
	BYTE	#<M_-_Monkey_Island_Visuals_Data_Channel_6
	BYTE	#>M_-_Monkey_Island_Visuals_Data_Channel_6	; 14
	BYTE	#<M_-_Monkey_Island_Visuals_Data_Channel_6
	BYTE	#>M_-_Monkey_Island_Visuals_Data_Channel_6	; 15

M_-_Monkey_Island_Visuals_Data_Channel_1
	BYTE	#0
	BYTE	#2
	BYTE	#4
	BYTE	#5
	...
	BYTE	#7
	BYTE	#7
M_-_Monkey_Island_Visuals_Data_Channel_4
	BYTE	#0
	BYTE	#0
	BYTE	#0
	BYTE	#0
	...
	BYTE	#5
	BYTE	#5
M_-_Monkey_Island_Visuals_Data_Channel_6
	BYTE	#2
	BYTE	#5
	BYTE	#6
	BYTE	#6
	...
	BYTE	#7
	BYTE	#7
M_-_Monkey_Island_Visuals_Data_Channel_12
	BYTE	#0
	BYTE	#0
	BYTE	#0
	BYTE	#0
...
M_-_Monkey_Island_Visuals_Data_Bars
	BYTE	#%00000000
	BYTE	#%10000000
	BYTE	#%11000000
	BYTE	#%11100000
...
M_-_Monkey_Island_Visuals_Data_Barcolors
	BYTE	#$18
	BYTE	#$16
	BYTE	#$14
	BYTE	#$38
	...
	align	256
M_-_Monkey_Island_Visuals_Display
	LDX	#0
M_-_Monkey_Island_Visuals_LineLoop
	STA	WSYNC	; 76
	LDA	MusicIndicator1,x		; 5
	lsr					; 2 (7)
	TAY					; 2 (9)
	STA	temp04				; 3 (12)
	LDA	M_-_Monkey_Island_Visuals_Data_Bars,y	; 5 (17)
	STA	PF2				; 3 (20)
	...
	CLC					; 2 (31)
	ADC 	M_-_Monkey_Island_Visuals_Data_Barcolors,y	; 5 (36)
	STA	COLUPF				; 3 (39)
	STA	temp03				; 3 (42)

	LDY	#3	; This is the line num!
M_-_Monkey_Island_Visuals_LineFiller
	STA	WSYNC
	DEC 	temp03
	...
	AND	#%00001111
	CMP	#$04
	BCC	M_-_Monkey_Island_Visuals_NoColorDECR
	DEC	temp03
M_-_Monkey_Island_Visuals_NoColorDECR
	LDA	temp03

	STA	COLUPF

	DEY
	BPL	M_-_Monkey_Island_Visuals_LineFiller
	STA	WSYNC
	LDA	frameColor
	STA	COLUPF
	...
	INX	
	CPX	#8
	BNE	M_-_Monkey_Island_Visuals_LineLoop

M_-_Monkey_Island_Visuals_DisplayEnded
	LDA	#0
	STA	ENAM0
	STA	HMCLR
...
fortari_BGColor
	...
	align	256
M_-_Monkey_Island_ReallyNiceText
	BYTE	#22
	BYTE	#36
	BYTE	#40
	BYTE	#36
...
***************************
	Bank 3
	fill	256
M_-_Monkey_Island_Driver0
	DEC	M_-_Monkey_Island_Duration0
	LDA	M_-_Monkey_Island_Duration0
	CMP	#0
	BNE	M_-_Monkey_Island_Skip0

M_-_Monkey_Island_ReadFirst0
	LDX	#M_-_Monkey_Island_Pointer0
	LDA	($00,x)
	INC	0,x
	BNE	*+4
	INC	1,x
	...
	STA	temp16
	STA	temp17
	JMP	M_-_Monkey_Island_NotSharedByte0

M_-_Monkey_Island_if2400
	CMP	#240
	BNE	M_-_Monkey_Island_NoRestart0

M_-_Monkey_Island_Restart0
	LDA	#<M_-_Monkey_Island_Data0
	STA	M_-_Monkey_Island_Pointer0
	LDA	#>M_-_Monkey_Island_Data0
	STA	M_-_Monkey_Island_Pointer0+1
	...
	JMP	M_-_Monkey_Island_ReadFirst0

M_-_Monkey_Island_NoRestart0
	STA	temp06
	AND	#%00001111
	CMP	#0
	BNE	M_-_Monkey_Island_CommonNote0
	LDA	temp06
	lsr
	lsr
	lsr
	lsr
	CMP	#%00001110
	BNE	M_-_Monkey_Island_NoRestorePointer0
	LDA	M_-_Monkey_Island_PointerBackUp0
	STA	M_-_Monkey_Island_Pointer0
	LDA	M_-_Monkey_Island_PointerBackUp0+1
	STA	M_-_Monkey_Island_Pointer0+1
	JMP	M_-_Monkey_Island_ReadFirst0
M_-_Monkey_Island_NoRestorePointer0
	
	LDY	M_-_Monkey_Island_Pointer0	
	STY	M_-_Monkey_Island_PointerBackUp0	
	LDY	M_-_Monkey_Island_Pointer0+1
	STY	M_-_Monkey_Island_PointerBackUp0+1	

	ASL
	TAX
	LDA	M_-_Monkey_Island_Data0_CompressedPointerTable,x
	STA	M_-_Monkey_Island_Pointer0
	LDA	M_-_Monkey_Island_Data0_CompressedPointerTable+1,x
	STA	M_-_Monkey_Island_Pointer0+1
	JMP	M_-_Monkey_Island_ReadFirst0

M_-_Monkey_Island_CommonNote0
	LDA	temp06
	STA	AUDV0
	STA	temp16
	lsr
	...
	CMP	#32
	BCC	M_-_Monkey_Island_NotSharedByte0
	...
	STA	M_-_Monkey_Island_Duration0
	JMP	M_-_Monkey_Island_Skip0

M_-_Monkey_Island_NotSharedByte0
...
M_-_Monkey_Island_Skip0
M_-_Monkey_Island_Driver1
	DEC	M_-_Monkey_Island_Duration1
	LDA	M_-_Monkey_Island_Duration1
	CMP	#0
	BNE	M_-_Monkey_Island_Skip1

M_-_Monkey_Island_ReadFirst1
	LDX	#M_-_Monkey_Island_Pointer1
	LDA	($00,x)
	INC	0,x
	BNE	*+4
	INC	1,x
	...
	STA	temp18
	STA	temp19
	JMP	M_-_Monkey_Island_NotSharedByte1

M_-_Monkey_Island_if2401
	CMP	#240
	BNE	M_-_Monkey_Island_NoRestart1

M_-_Monkey_Island_Restart1
	LDA	#<M_-_Monkey_Island_Data0
	STA	M_-_Monkey_Island_Pointer0
	LDA	#>M_-_Monkey_Island_Data0
	STA	M_-_Monkey_Island_Pointer0+1
	...
	JMP	M_-_Monkey_Island_ReadFirst1

M_-_Monkey_Island_NoRestart1
	STA	temp06
	AND	#%00001111
	CMP	#0
	BNE	M_-_Monkey_Island_CommonNote1
	LDA	temp06
	lsr
	lsr
	lsr
	lsr
	CMP	#%00001110
	BNE	M_-_Monkey_Island_NoRestorePointer1
	LDA	M_-_Monkey_Island_PointerBackUp1
	STA	M_-_Monkey_Island_Pointer1
	LDA	M_-_Monkey_Island_PointerBackUp1+1
	STA	M_-_Monkey_Island_Pointer1+1
	JMP	M_-_Monkey_Island_ReadFirst1
M_-_Monkey_Island_NoRestorePointer1
	
	LDY	M_-_Monkey_Island_Pointer1	
	STY	M_-_Monkey_Island_PointerBackUp1	
	LDY	M_-_Monkey_Island_Pointer1+1
	STY	M_-_Monkey_Island_PointerBackUp1+1	

	ASL
	TAX
	LDA	M_-_Monkey_Island_Data1_CompressedPointerTable,x
	STA	M_-_Monkey_Island_Pointer1
	LDA	M_-_Monkey_Island_Data1_CompressedPointerTable+1,x
	STA	M_-_Monkey_Island_Pointer1+1
	JMP	M_-_Monkey_Island_ReadFirst1

M_-_Monkey_Island_CommonNote1
	LDA	temp06
	STA	AUDV1
	STA	temp18
	lsr
	...
	CMP	#32
	BCC	M_-_Monkey_Island_NotSharedByte1
	...
	STA	M_-_Monkey_Island_Duration1
	JMP	M_-_Monkey_Island_Skip1

M_-_Monkey_Island_NotSharedByte1
...
M_-_Monkey_Island_Skip1
	...
	lda	temp02
   	...
   	pha
	jmp	bankSwitchJump
M_-_Monkey_Island_Data0_CompressedPointerTable
	BYTE	#0
	BYTE	#0
	BYTE	#<M_-_Monkey_Island_Channel0_00010000
	BYTE	#>M_-_Monkey_Island_Channel0_00010000
	BYTE	#0
	BYTE	#0
	BYTE	#0
...
M_-_Monkey_Island_Channel0_00010000
	BYTE	#%11001100
	BYTE	#%10110100
	BYTE	#%11000110
	BYTE	#%00110100
...
M_-_Monkey_Island_Data1_CompressedPointerTable
	BYTE	#0
	BYTE	#0
	BYTE	#<M_-_Monkey_Island_Channel1_00010000
	BYTE	#>M_-_Monkey_Island_Channel1_00010000
	BYTE	#0
	BYTE	#0
	BYTE	#0
...
M_-_Monkey_Island_Channel1_00010000
	BYTE	#%11001100
	BYTE	#%10110100
	BYTE	#%11100000


M_-_Monkey_Island_Data1
	BYTE	#%00000000
	BYTE	#%00110010
	BYTE	#%11001100
	BYTE	#%01001111
