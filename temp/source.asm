...
Bank2_MiniMap_MiniMap_MiniMap_Kernel_BallX_Loop
	...
	TAX
	TXS
	JMP	Bank2_MiniMap_Kernel_MainLoop
...
Bank2_MiniMap_Kernel_MainLoop
	...
	CPY 	temp12
	BNE	Bank2_MiniMap_Kernel_Not_Enabled2
	LDA	#2
	JMP	Bank2_MiniMap_Kernel_Enabled2
Bank2_MiniMap_Kernel_Not_Enabled2
	sleep	3
	LDA	#0
Bank2_MiniMap_Kernel_Enabled2
	STA	temp15
	...
	DEY	
	BMI	Bank2_MiniMap_Kernel_EndLoop
