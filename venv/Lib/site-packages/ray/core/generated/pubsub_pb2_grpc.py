...
class PublisherService(object):
    ...
    def PubsubLongPolling(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ray.rpc.PublisherService/PubsubLongPolling',
    ...
    def PubsubCommandBatch(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ray.rpc.PublisherService/PubsubCommandBatch',
