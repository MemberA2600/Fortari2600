...
NewLine
	...
	LDA	temp02		; 3 (6)
	STA	COLUPF		; 3 (9)
	LDA	(pf0Pointer),y	; 5 (14)
	STA	PF0		; 3 (17)	
	STA	temp03		; 3 (20)
	LDA	(pf1Pointer),y	; 5 (25)	
	STA	PF1		; 3 (28)
	...
	LDA	(pfColorPointer),y	; 5 (11)
	CLC			; 2 (13)	
	ADC	pfBaseColor 	; 3 (16)
	STA	temp02		; savePFColor 3 (19)
	...
	LDA	(bkColorPointer),y ; 3 (11)	
	CLC			; 2 (13)	
	ADC	bkBaseColor 	; 3 (16)
	STA	temp04		; saveBKColor 3 (19)
