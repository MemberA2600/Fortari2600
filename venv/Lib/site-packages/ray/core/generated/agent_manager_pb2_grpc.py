...
class AgentManagerService(object):
    ...
    def RegisterAgent(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ray.rpc.AgentManagerService/RegisterAgent',
            src_dot_ray_dot_protobuf_dot_agent__manager__pb2.RegisterAgentRequest.SerializeToString,
            src_dot_ray_dot_protobuf_dot_agent__manager__pb2.RegisterAgentReply.FromString,
