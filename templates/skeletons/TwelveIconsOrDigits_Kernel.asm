...
#BANK#_TwelveIconsOrDigits_Interlaced_RESP_JumpHere
	...
	LDA	#BANK#_TwelveIconsOrDigits_Interlaced_PF0_Table,x
	STA	PF0

	LDA	#BANK#_TwelveIconsOrDigits_Interlaced_PF2_Table,x
	STA	PF2

	LDA	#BANK#_TwelveIconsOrDigits_Interlaced_PF1_Table,x
	STA	temp19
...
#BANK#_TwelveIconsOrDigits_Interlaced_PF0_Table
	BYTE	#%11110000
	BYTE	#%11110000
	BYTE	#%11000000
	BYTE	#%00000000
...
#BANK#_TwelveIconsOrDigits_Interlaced_PF1_Table
	BYTE	#%11111111
	BYTE	#%11111111
	BYTE	#%11111111
	BYTE	#%11111111
...
#BANK#_TwelveIconsOrDigits_Interlaced_PF2_Table
	BYTE	#%11000000
	BYTE	#%00000000
	BYTE	#%00000000
	BYTE	#%00000000
