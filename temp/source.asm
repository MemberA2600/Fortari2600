...
Bank2_ChangeFrameColor_ChangeFrameColor
	LDA	#$74
	STA	frameColor
...
Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke
	LDA	frameColor
	LDX	#0
	STA	WSYNC		; 76
	...
	JMP	Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_OverJumpTable
	align	256

Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_FineAdjustTable256	
	fill	79

Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Movement
	BYTE	#249
	BYTE	#250
	BYTE	#251
	BYTE	#252
...
Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Back_Gradient
	BYTE	#$00
	BYTE	#$00
	BYTE	#$02
	BYTE	#$00
...
Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Gradient
	BYTE	#$0a
	BYTE	#$0a
	BYTE	#$08
	BYTE	#$0a
...
Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_AND
	BYTE	#3
	BYTE	#3
	BYTE	#3
	BYTE	#3
...
Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_PointerNum
	BYTE	#7
	BYTE	#8
	BYTE	#9
	BYTE	#10
...
Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Pattern_0
	BYTE	#0
	BYTE	#0
	BYTE	#0
	BYTE	#0
	...
	BYTE	#0
	BYTE	#0
Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Pattern_1
	BYTE	#255
	BYTE	#255
	BYTE	#255
	BYTE	#255
...
Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_MASK
	BYTE	#%00111100
	BYTE	#%01111110
	BYTE	#%11111111
	BYTE	#%11111111
...
Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_FineAdjustTable
	byte	#$80
	byte	#$70
	byte	#$60
	byte	#$50
...
Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_OverJumpTable

	LDA	P0Height
	BMI	Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Off
	LDA	#<Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Pattern_0
	STA	temp19
	JMP	Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_On
Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Off
	LDA	#<Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Pattern_1
	STA	temp19
Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_On
...
Bank2_No_Smoke_Counter
	...
	LSR
	TAY	
Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Set_HorPoz
	LDA	Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_PointerNum,y
	SEC
	SBC	#6
	...
	INY
	CPX	#15	
	BEQ	Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Set_HorPoz_Ended	
	JMP	Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Set_HorPoz

Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Set_HorPoz_Ended
...
Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Add_Wind_Loop
	TYA
	CLC
	ADC	temp18	
	TAY
	...
	STA	temp02,x
	DEX
	BPL	Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Add_Wind_Loop
	...
	LDA	Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Gradient	
	ADC	#$02			
	STA	COLUP0			
	...
	JMP	Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Draw_Loop_0

	_align	150

Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Draw_Loop_0	
	
	STA	WSYNC
	LDA	#0
	STA	GRP0
	LDA	temp02,x
Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Draw_Loop_Hor_0
	SBC	#15
	BCS	Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Draw_Loop_Hor_0
	TAY
	sleep	3
	STA	RESP0
	LDA	Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_FineAdjustTable256,y
	STA	HMP0

	LDA	Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Back_Gradient,x		
	STA	WSYNC			; 76
	STA	HMOVE			; 3
	ADC	#$74	
	STA	COLUBK			; 3 (6)
	...
	LDA	temp19			; 3 (9)
	AND	Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_MASK,x	; 5 (14)
	STA	GRP0			; 3 (17)
	...
	LDA	Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Gradient,x	; 5 (53)
	ADC	#$02			; 3 (56)
	STA	COLUP1			; 3 (59)
	LDA	#0
	STA	HMP0

Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Draw_Loop_1	
	
	STA	WSYNC
	LDA	#0
	STA	GRP1
	LDA	temp02,x
Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Draw_Loop_Hor_1
	SBC	#15
	BCS	Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Draw_Loop_Hor_1
	TAY
	sleep	3
	STA	RESP1
	LDA	Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_FineAdjustTable256,y
	...
	INX				; 2 (21)
	CPX	#16			; 2 (23)
	BEQ	Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Reset	; 2 (25)
	...
	JMP	Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Draw_Loop_0	; 3 (62)

Bank2_SpecialEffect_SpecialEffect_Smoke_Smoke_Reset
	LDA	frameColor
	LDX	#0
	STA	WSYNC
	STA	COLUBK
