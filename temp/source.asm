...
Bank2_Indicator_Indicator_OneIconWithDigits
	LDA	frameColor
	STA	COLUPF
	LDA	#$16
	STA	temp17
	...
	AND	#%00000001
	CMP	#%00000001
	BEQ	Bank2_Indicator_Indicator_OneIconWithDigits_Odd_Frame
	...
	JMP	Bank2_Indicator_Indicator_OneIconWithDigits_Even_Frame
Bank2_Indicator_Indicator_OneIconWithDigits_Odd_Frame
...
Bank2_Indicator_Indicator_OneIconWithDigits_Even_Frame
	LDA	#%00001007
	STA	REFP0
	STA	NUSIZ0
	AND	#%11110000
	...
	STA	temp11
	STX	temp12
	LDA	#<Bank2_8PixNumbers_Empty
	LDX	#>Bank2_8PixNumbers_Empty
	STA	temp07
	STX	temp08
	STA	temp09
	STX	temp10
	...
	ADC	temp11
	STA	temp11
	LDA	#<Bank2_Indicator_Indicator_OneIconWithDigits_Back
	STA	temp01
	LDA	#>Bank2_Indicator_Indicator_OneIconWithDigits_Back
	STA	temp02
	JMP	Bank2_OneIconWithDigits_Kernel
Bank2_Indicator_Indicator_OneIconWithDigits_Back
...
Bank2_OneIconWithDigits_Kernel
	LDA	#0			; 2 (64)
	LDX	frameColor		; 3 (67)
	STA	WSYNC			; 3 (76)
	STA	HMCLR			; 3 
	...
	ROR				; 2 (33)
	TAX 
	LDA	Bank2_OneIconWithDigits_HMOVE_TABLE,x
	STA	HMP1			; 3 
	...
	LDA	temp05			; 3
	CMP	#0			; 2 (5)
	BEQ	Bank2_OneIconWithDigits_P0_0
					; 2 (7)
	CMP	#5			; 2 (9)
	BEQ	Bank2_OneIconWithDigits_P0_5
					; 2 (11)
	LDY	#7			; 2 
	JMP	Bank2_OneIconWithDigits_P0_7
					; 3 (16)
Bank2_OneIconWithDigits_HMOVE_TABLE
	BYTE	#$10
	BYTE	#$10

Bank2_OneIconWithDigits_P0_0
	sleep	7
Bank2_OneIconWithDigits_P0_5
	sleep	9
Bank2_OneIconWithDigits_P0_7
	sleep	4
	STA	RESP0			; 3 (30?)
...
*	LDA	temp17			; 3 (35)
*	AND	#%00000001		; 2 (37)
*	BEQ	Bank2_OneIconWithDigits_TwoDigitMode	; 2 (39)
	...
	AND	#%00000001		; 2 (5)
	CMP	#%00000001		; 2 (7)
	BEQ	Bank2_OneIconWithDigits_Prepare_Odd	; 2 (9)
Bank2_OneIconWithDigits_Prepare_Even
	LDA	#$80			; 2 (11)
	STA	HMP1			; 3 (14)
*
*	Preload colors
*
	...
	JMP	Bank2_OneIconWithDigits_Loop_Even	; 3 (17)
	
Bank2_OneIconWithDigits_Prepare_Odd
	LDA	#$00			; 2 (11)
	STA	HMP1			; 3 (14)
	...
	JMP	Bank2_OneIconWithDigits_Loop_odd	; 3 (71)

	_align	90

Bank2_OneIconWithDigits_Loop_Even
	STA	WSYNC			; 76
	STA	HMOVE			; 3 
	LDA	(temp03),y		; 5 (8)
	STA	GRP0			; 3 (11)
...
Bank2_OneIconWithDigits_Loop_Even_Secondline
	STA	HMOVE			; 3 (74)
	LDA	(temp03),y		; 5 (3)
	STA	GRP0			; 3 (6)
	LDA	(temp05),y		; 5 (11)
	...
	BNE	Bank2_OneIconWithDigits_Loop_Even	; 2 (72)
	JMP	Bank2_OneIconWithDigits_Ended

	_align 	85

Bank2_OneIconWithDigits_Loop_odd
	STA	HMOVE			; 74
	...
	LDA	#$80			; 2 (70)
	STA	HMP1			; 3 (73)
Bank2_OneIconWithDigits_Loop_SecondLine
	STA	WSYNC			; 76
	STA	HMOVE			; 3
...
*	sleep	2
	...
	STA	HMP1			; 3 (68)
	CPY	#255			; 2 (70)
	BNE	Bank2_OneIconWithDigits_Loop_odd	; 2 (72)	
	
Bank2_OneIconWithDigits_Ended
	LDA	frameColor
	LDX	#0
	STX	HMCLR
	STA	COLUPF
