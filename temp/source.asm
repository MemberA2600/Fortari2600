...
Bank2_BigSprite_BigSprite_Battery_(Big)
	LDA	#%00010000
	STA	temp17
	LDA	#$00
	STA	temp16
...
* mono:			temp19
	...
	LDA	#<Bank2_BigSprite_BigSprite_Battery_(Big)_BigSprite_0
	STA	temp03
	LDA	#>Bank2_BigSprite_BigSprite_Battery_(Big)_BigSprite_0
	STA	temp04

	LDA	#<Bank2_BigSprite_BigSprite_Battery_(Big)_BigSprite_1
	STA	temp05
	LDA	#>Bank2_BigSprite_BigSprite_Battery_(Big)_BigSprite_1
	STA	temp06

	LDA	#<Bank2_BigSprite_BigSprite_Battery_(Big)_BigSpriteColor_0
	STA	temp07
	LDA	#>Bank2_BigSprite_BigSprite_Battery_(Big)_BigSpriteColor_0
	STA	temp08

	LDA	#<Bank2_BigSprite_BigSprite_Battery_(Big)_BigSpriteColor_1
	STA	temp09
	LDA	#>Bank2_BigSprite_BigSprite_Battery_(Big)_BigSpriteColor_1
	STA	temp10

	LDA	#<Bank2_BigSprite_BigSprite_Battery_(Big)_BigSpriteBG
	STA	temp11
	LDA	#>Bank2_BigSprite_BigSprite_Battery_(Big)_BigSpriteBG
	STA	temp12
	...
	LDA	temp15
	CMP	#255
	BNE	Bank2_BigSprite_BigSprite_Battery_(Big)_NoTurnOff

	LDA	temp17
	AND	#%00001111
	STA	temp17
	
	LDA	#<Bank2_BigSprite_BigSprite_Battery_(Big)_Empty
	STA	temp03
	STA	temp05
	LDA	#>Bank2_BigSprite_BigSprite_Battery_(Big)_Empty
	STA	temp04
...
Bank2_BigSprite_BigSprite_Battery_(Big)_NoTurnOff
	LDA	#<Bank2_BigSprite_BigSprite_Battery_(Big)_Back
	STA	temp01
	LDA	#>Bank2_BigSprite_BigSprite_Battery_(Big)_Back
	STA	temp02
	JMP	Bank2_BigSprite_Kernel_Begin
Bank2_BigSprite_BigSprite_Battery_(Big)_Back
