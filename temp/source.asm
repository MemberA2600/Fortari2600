...
MaSu_-_Masu_Pointer0 = $e2
MaSu_-_Masu_Duration0 = $e4
MaSu_-_Masu_Pointer1 = $e5
MaSu_-_Masu_Duration1 = $e7
MaSu_-_Masu_PointerBackUp0 = $e8
MaSu_-_Masu_PointerBackUp1 = $ea


MaSu_-_Masu_Init
	LDA	#1
	STA	MaSu_-_Masu_Duration0
	STA	MaSu_-_Masu_Duration1

	LDA	#<MaSu_-_Masu_Data0
	STA	MaSu_-_Masu_Pointer0
	LDA	#>MaSu_-_Masu_Data0
	STA	MaSu_-_Masu_Pointer0+1

	LDA	#<MaSu_-_Masu_Data1
	STA	MaSu_-_Masu_Pointer1
	LDA	#>MaSu_-_Masu_Data1
	STA	MaSu_-_Masu_Pointer1+1
...
MaSu_-_Masu_Move_text

	LDA	#TextEnd 
	CMP	#0
	BEQ	MaSu_-_Masu_Move_Ended

	LDA	counter
	AND	#%00011111
	CMP	#%00011111

	BNE	MaSu_-_Masu_Move_Ended

	LDA	TextDir
	CMP	#0
	BNE	MaSu_-_Masu_Text_Reversed

	LDA	TextPoz
	CMP	#TextEnd
	BCC	MaSu_-_Masu_INCR

	LDA	#1
	STA	TextDir
	JMP	MaSu_-_Masu_DECR	
MaSu_-_Masu_INCR
	INC	TextPoz
	JMP	MaSu_-_Masu_Move_Ended

MaSu_-_Masu_Text_Reversed
	LDA	TextPoz
	CMP	#0
	BNE	MaSu_-_Masu_DECR
	STA	TextDir
	JMP	MaSu_-_Masu_INCR
MaSu_-_Masu_DECR
	DEC	TextPoz
MaSu_-_Masu_Move_Ended

	LDY	TextPoz
	LDX	#255

MaSu_-_Masu_Text_Create_Loop
	INX
	CPX	#12
	BEQ	MaSu_-_Masu_Text_Create_End

	LDA	MaSu_-_Masu_ReallyNiceText,y
	STA	Letter01,x
	INY
	JMP	MaSu_-_Masu_Text_Create_Loop

MaSu_-_Masu_Text_Create_End
	LDA	#2
	asl
	...
	lda	#<(MaSu_-_Masu_JumpBack-1)
	sta	temp01
   	lda	#>(MaSu_-_Masu_JumpBack-1)
	sta	temp02

	lda	#>(MaSu_-_Masu_Driver0-1)
   	pha
   	lda	#<(MaSu_-_Masu_Driver0-1)
   	pha
   	pha
...
MasuLogo_KernelStart
	...
	AND	#%00000001	; 2 (45)
	CMP	#%00000001	; 2 (47)
	BNE	MasuLogo_OddFrameJMP  ; 2 (49)
	JMP	MasuLogo_EvenFrame ; 3 (52)	
MasuLogo_OddFrameJMP
	JMP	MasuLogo_OddFrame  ; 3 (52)
...
MasuLogo_OddFrame
	...
	LAX	MasuLogo_06,y			; 4 (12)
		
	LDA	#$00				; 2 (14)
	STA 	HMP0				; 3 (17) 
	LDA	#$20				; 2 (19)
	STA 	HMP1				; 3 (22)
	LDA	MasuLogo_00,y			; 4 (26)
	STA	GRP0				; 3 (29)
	LDA	MasuLogo_02,y			; 4 (33)
	STA	GRP1				; 3 (36)

	STA	WSYNC
MasuLogo_OddFrame_LineDummy
	STA	HMOVE				; 3 

	sleep	7
						; 3 (10)	
	LDA	MasuLogo_PF,y			; 4 (14)
	STA	PF2				; 3 (17)
	LDA	frameColor
	sleep	2
	STA	COLUPF				; 3 (24)
	...
	LDA	MasuLogo_00,y			; 4 (38)
	STA	GRP0				; 3 (41)
	LDA	MasuLogo_02,y			; 4 (45)
	STA	GRP1				; 3 (48)

	LDA	MasuLogo_04,y			; 4 (52)
	STA	GRP0				; 3 (55)
	...
	STA 	HMP0				; 3 (70)
	STA 	HMP1				; 3 (73)
	JMP	MasuLogo_OddFrame_Line2

MasuLogo_OddFrame_Line1
	STA	HMOVE				; 3 

	LDA	MasuLogo_BGColor,y		; 4 (7)
	STA	COLUBK				; 3 (10)	
	LDA	MasuLogo_PF,y			; 4 (14)
	STA	PF2				; 3 (17)
	LDA	MasuLogo_PFColor,y		; 4 (21)
	STA	COLUPF				; 3 (24)
		
	LDA	MasuLogo_Color,y			; 4 (28)
	STA	COLUP0				; 3 (31)
	STA	COLUP1				; 3 (34)
...
MasuLogo_OddFrame_Line2
	...
	DEY					; 2 (66)
	CPY	temp02				; 3 (69)
	BEQ	MasuLogo_Reset			; 2 (71)	
	JMP	MasuLogo_OddFrame_Line1		; 3 (74)
...
MasuLogo_EvenFrame_LineDummy	
	STA 	WSYNC
	STA	HMOVE
	_sleep	50
	sleep	3

	LDA	MasuLogo_PFColor,y		
	STA	COLUPF	

	LDA	#$00				; 2 
	STA 	HMP0				; 3 
	STA 	HMP1				; 3 
	JMP	MasuLogo_EvenFrame_Line2

MasuLogo_EvenFrame_Line1			
	STA 	WSYNC				; 76
	STA	HMOVE				; 3
...
MasuLogo_EvenFrame_Line2
	...
	CPY	temp02				; 3 (71)
	BNE	MasuLogo_EvenFrame_Line1		; 2 (73)
...
MaSu_-_MasuFillerLine1
	LDA	counter	
	AND	#%00000010
	CMP	#%00000010
	BEQ	MaSu_-_MasuCalculateDataStart
	STA	WSYNC
	STA	WSYNC

MaSu_-_MasuCalculateDataStart
	STA	WSYNC
	LDX	#0
MaSu_-_MasuResetGRP
	STX	GRP0
...
MaSu_-_MasuOddLine
	...
	JMP	MaSu_-_MasuThisLineIsCalculated	
MaSu_-_MasuEvenLine
	LDA	Letter02
	TAX
	LDA	Bank25Table,x		; Got the starting address
...
MaSu_-_MasuThisLineIsCalculated	
	LDA	TextColor
	ADC	Bank2Colors,y
	STA	COLUP0
	STA	COLUP1
	...
	BIT	temp08
	BPL	MaSu_-_MasuNoReColor
	STA	COLUPF
MaSu_-_MasuNoReColor
	...
	DEC	temp02		; 5
	LDY	temp02		; 3
	BMI	MaSu_-_MasuFillerLine2	; 2 
	JMP	MaSu_-_MasuCalculateDataStart   ; 3

MaSu_-_MasuFillerLine2
	LDA	#0
	STA	GRP0
	STA	GRP1
	STA 	ENABL		
...
MusicIndicator8 = $ce
	...
	AND	#%00000011
	CMP	#%00000011
	BEQ	MaSu_-_Masu_Visuals_DECR
	
	_sleep	34
	sleep	3
	JMP	MaSu_-_Masu_Visuals_NoLSR

MaSu_-_Masu_Visuals_DECR
	LSR	MusicIndicator1
	LSR	MusicIndicator2
	LSR	MusicIndicator3
	LSR	MusicIndicator4
...
*
	...
	LDA	MaSu_-_Masu_Visuals_Data_Pointers,y
	CMP	#0
	BEQ	MaSu_-_Masu_Visuals_NoChangeChannel0
	...
	BCC	MaSu_-_Masu_Visuals_NoChangeChannel0
	STA	MusicIndicator1,x

MaSu_-_Masu_Visuals_NoChangeChannel0
	STA	WSYNC
	...
	LDA	MaSu_-_Masu_Visuals_Data_Pointers,y
	CMP	#0
	BEQ	MaSu_-_Masu_Visuals_NoChangeChannel1
	...
	LDA	temp03
	CMP	MusicIndicator1,x
	BCC	MaSu_-_Masu_Visuals_NoChangeChannel1
	STA	MusicIndicator1,x

MaSu_-_Masu_Visuals_NoChangeChannel1
	JMP	MaSu_-_Masu_Visuals_Display

MaSu_-_Masu_Visuals_Data

MaSu_-_Masu_Visuals_Data_Pointers
	BYTE	#0
	BYTE	#0				; 0
	BYTE	#<MaSu_-_Masu_Visuals_Data_Channel_1
	BYTE	#>MaSu_-_Masu_Visuals_Data_Channel_1	; 1
	BYTE	#<MaSu_-_Masu_Visuals_Data_Channel_6
	BYTE	#>MaSu_-_Masu_Visuals_Data_Channel_6	; 2
	BYTE	#<MaSu_-_Masu_Visuals_Data_Channel_6
	BYTE	#>MaSu_-_Masu_Visuals_Data_Channel_6	; 3	
	BYTE	#<MaSu_-_Masu_Visuals_Data_Channel_4
	BYTE	#>MaSu_-_Masu_Visuals_Data_Channel_4	; 4
	BYTE	#<MaSu_-_Masu_Visuals_Data_Channel_6
	BYTE	#>MaSu_-_Masu_Visuals_Data_Channel_6	; 6
	BYTE	#<MaSu_-_Masu_Visuals_Data_Channel_6
	BYTE	#>MaSu_-_Masu_Visuals_Data_Channel_6	; 6
	BYTE	#<MaSu_-_Masu_Visuals_Data_Channel_6
	BYTE	#>MaSu_-_Masu_Visuals_Data_Channel_6	; 7
	BYTE	#<MaSu_-_Masu_Visuals_Data_Channel_6
	BYTE	#>MaSu_-_Masu_Visuals_Data_Channel_6	; 8
	BYTE	#<MaSu_-_Masu_Visuals_Data_Channel_6
	BYTE	#>MaSu_-_Masu_Visuals_Data_Channel_6	; 9
	BYTE	#<MaSu_-_Masu_Visuals_Data_Channel_6
	BYTE	#>MaSu_-_Masu_Visuals_Data_Channel_6	; 10
	BYTE	#<MaSu_-_Masu_Visuals_Data_Channel_6
	BYTE	#>MaSu_-_Masu_Visuals_Data_Channel_6	; 11
	BYTE	#<MaSu_-_Masu_Visuals_Data_Channel_12
	BYTE	#>MaSu_-_Masu_Visuals_Data_Channel_12	; 12
	BYTE	#<MaSu_-_Masu_Visuals_Data_Channel_6
	BYTE	#>MaSu_-_Masu_Visuals_Data_Channel_6	; 13
	BYTE	#<MaSu_-_Masu_Visuals_Data_Channel_6
	BYTE	#>MaSu_-_Masu_Visuals_Data_Channel_6	; 14
	BYTE	#<MaSu_-_Masu_Visuals_Data_Channel_6
	BYTE	#>MaSu_-_Masu_Visuals_Data_Channel_6	; 15

MaSu_-_Masu_Visuals_Data_Channel_1
	BYTE	#0
	BYTE	#2
	BYTE	#4
	BYTE	#5
	...
	BYTE	#7
	BYTE	#7
MaSu_-_Masu_Visuals_Data_Channel_4
	BYTE	#0
	BYTE	#0
	BYTE	#0
	BYTE	#0
	...
	BYTE	#5
	BYTE	#5
MaSu_-_Masu_Visuals_Data_Channel_6
	BYTE	#2
	BYTE	#5
	BYTE	#6
	BYTE	#6
	...
	BYTE	#7
	BYTE	#7
MaSu_-_Masu_Visuals_Data_Channel_12
	BYTE	#0
	BYTE	#0
	BYTE	#0
	BYTE	#0
...
MaSu_-_Masu_Visuals_Data_Barcolors
	BYTE	#$18
	BYTE	#$16
	BYTE	#$14
	BYTE	#$38
	...
	align	256
MaSu_-_Masu_Visuals_Display
	LDX	#0
MaSu_-_Masu_Visuals_LineLoop
	STA	WSYNC	; 76
	LDA	MusicIndicator1,x		; 5
	lsr					; 2 (7)
	TAY					; 2 (9)
	STA	temp04				; 3 (12)
	LDA	MaSu_-_Masu_Visuals_Data_Bars,y	; 5 (17)
	STA	PF2				; 3 (20)
	...
	CLC					; 2 (31)
	ADC 	MaSu_-_Masu_Visuals_Data_Barcolors,y	; 5 (36)
	STA	COLUPF				; 3 (39)
	STA	temp03				; 3 (42)

	LDY	#3	; This is the line num!
MaSu_-_Masu_Visuals_LineFiller
	STA	WSYNC
	DEC 	temp03
	...
	AND	#%00001111
	CMP	#$04
	BCC	MaSu_-_Masu_Visuals_NoColorDECR
	DEC	temp03
MaSu_-_Masu_Visuals_NoColorDECR
	LDA	temp03

	STA	COLUPF

	DEY
	BPL	MaSu_-_Masu_Visuals_LineFiller
	STA	WSYNC
	LDA	frameColor
	STA	COLUPF
	...
	INX	
	CPX	#8
	BNE	MaSu_-_Masu_Visuals_LineLoop

MaSu_-_Masu_Visuals_DisplayEnded
	LDA	#0
	STA	ENAM0
	STA	HMCLR
...
***************************
	...
	fill	256
MaSu_-_Masu_Driver0
	DEC	MaSu_-_Masu_Duration0
	LDA	MaSu_-_Masu_Duration0
	CMP	#0
	BNE	MaSu_-_Masu_Skip0

MaSu_-_Masu_ReadFirst0
	LDX	#MaSu_-_Masu_Pointer0
	LDA	($00,x)
	INC	0,x
	BNE	*+4
	INC	1,x
	...
	STA	temp16
	STA	temp17
	JMP	MaSu_-_Masu_NotSharedByte0

MaSu_-_Masu_if2400
	CMP	#240
	BNE	MaSu_-_Masu_NoRestart0

MaSu_-_Masu_Restart0
	LDA	#<MaSu_-_Masu_Data0
	STA	MaSu_-_Masu_Pointer0
	LDA	#>MaSu_-_Masu_Data0
	STA	MaSu_-_Masu_Pointer0+1

	JMP	MaSu_-_Masu_ReadFirst0

MaSu_-_Masu_NoRestart0
	STA	temp06
	AND	#%00001111
	CMP	#0
	BNE	MaSu_-_Masu_CommonNote0
	LDA	temp06
	lsr
	lsr
	lsr
	lsr
	CMP	#%00001110
	BNE	MaSu_-_Masu_NoRestorePointer0
	LDA	MaSu_-_Masu_PointerBackUp0
	STA	MaSu_-_Masu_Pointer0
	LDA	MaSu_-_Masu_PointerBackUp0+1
	STA	MaSu_-_Masu_Pointer0+1
	JMP	MaSu_-_Masu_ReadFirst0
MaSu_-_Masu_NoRestorePointer0
	
	LDY	MaSu_-_Masu_Pointer0	
	STY	MaSu_-_Masu_PointerBackUp0	
	LDY	MaSu_-_Masu_Pointer0+1
	STY	MaSu_-_Masu_PointerBackUp0+1	

	ASL
	TAX
	LDA	MaSu_-_Masu_Data0_CompressedPointerTable,x
	STA	MaSu_-_Masu_Pointer0
	LDA	MaSu_-_Masu_Data0_CompressedPointerTable+1,x
	STA	MaSu_-_Masu_Pointer0+1
	JMP	MaSu_-_Masu_ReadFirst0

MaSu_-_Masu_CommonNote0
	LDA	temp06
	STA	AUDV0
	STA	temp16
	lsr
	...
	CMP	#32
	BCC	MaSu_-_Masu_NotSharedByte0
	...
	STA	MaSu_-_Masu_Duration0
	JMP	MaSu_-_Masu_Skip0

MaSu_-_Masu_NotSharedByte0
...
MaSu_-_Masu_Skip0
	lda	#>(MaSu_-_Masu_Driver1-1)
   	...
   	ldx	#4
   	jmp	bankSwitchJump
MaSu_-_Masu_Data0_CompressedPointerTable
	BYTE	#0
	BYTE	#0
	BYTE	#<MaSu_-_Masu_Channel0_00010000
	BYTE	#>MaSu_-_Masu_Channel0_00010000
	BYTE	#<MaSu_-_Masu_Channel0_00100000
	BYTE	#>MaSu_-_Masu_Channel0_00100000
	BYTE	#<MaSu_-_Masu_Channel0_00110000
	BYTE	#>MaSu_-_Masu_Channel0_00110000
	BYTE	#<MaSu_-_Masu_Channel0_01000000
	BYTE	#>MaSu_-_Masu_Channel0_01000000
	BYTE	#<MaSu_-_Masu_Channel0_01010000
	BYTE	#>MaSu_-_Masu_Channel0_01010000
	BYTE	#<MaSu_-_Masu_Channel0_01100000
	BYTE	#>MaSu_-_Masu_Channel0_01100000
	BYTE	#<MaSu_-_Masu_Channel0_01110000
	BYTE	#>MaSu_-_Masu_Channel0_01110000
	BYTE	#<MaSu_-_Masu_Channel0_10000000
	BYTE	#>MaSu_-_Masu_Channel0_10000000
	BYTE	#<MaSu_-_Masu_Channel0_10010000
	BYTE	#>MaSu_-_Masu_Channel0_10010000
	BYTE	#<MaSu_-_Masu_Channel0_10100000
	BYTE	#>MaSu_-_Masu_Channel0_10100000
	BYTE	#0
	BYTE	#0
	BYTE	#0
...
MaSu_-_Masu_Channel0_00100000
	BYTE	#%11110110
	BYTE	#%01010100
	BYTE	#%11100000

MaSu_-_Masu_Channel0_00110000
	BYTE	#%10000110
	BYTE	#%01001000
	BYTE	#%11100000

MaSu_-_Masu_Channel0_01000000
	BYTE	#%11001000
	BYTE	#%00011010
	BYTE	#%00010000
	BYTE	#%11100000

MaSu_-_Masu_Channel0_01010000
	BYTE	#%00010011
	BYTE	#%00001111
	BYTE	#%00010010
	BYTE	#%11100000

MaSu_-_Masu_Channel0_01100000
	BYTE	#%11001000
	BYTE	#%00011010
	BYTE	#%00001111
	BYTE	#%11100000

MaSu_-_Masu_Channel0_01110000
	BYTE	#%11001000
	BYTE	#%00011111
	BYTE	#%00010000
	BYTE	#%11100000

MaSu_-_Masu_Channel0_10000000
	BYTE	#%00010011
	BYTE	#%00001111
	BYTE	#%00001111
	BYTE	#%11100000

MaSu_-_Masu_Channel0_10010000
	BYTE	#%00010011
	BYTE	#%00001111
	BYTE	#%00010001
	BYTE	#%11100000

MaSu_-_Masu_Channel0_10100000
	BYTE	#%11110101
	BYTE	#%01010100
	BYTE	#%11100000
...
***************************
	...
	fill	256
MaSu_-_Masu_Driver1
	DEC	MaSu_-_Masu_Duration1
	LDA	MaSu_-_Masu_Duration1
	CMP	#0
	BNE	MaSu_-_Masu_Skip1

MaSu_-_Masu_ReadFirst1
	LDX	#MaSu_-_Masu_Pointer1
	LDA	($00,x)
	INC	0,x
	BNE	*+4
	INC	1,x
	...
	STA	temp18
	STA	temp19
	JMP	MaSu_-_Masu_NotSharedByte1

MaSu_-_Masu_if2401
	CMP	#240
	BNE	MaSu_-_Masu_NoRestart1

MaSu_-_Masu_Restart1
	LDA	#<MaSu_-_Masu_Data1
	STA	MaSu_-_Masu_Pointer1
	LDA	#>MaSu_-_Masu_Data1
	STA	MaSu_-_Masu_Pointer1+1

	JMP	MaSu_-_Masu_ReadFirst1

MaSu_-_Masu_NoRestart1
	STA	temp06
	AND	#%00001111
	CMP	#0
	BNE	MaSu_-_Masu_CommonNote1
	LDA	temp06
	lsr
	lsr
	lsr
	lsr
	CMP	#%00001110
	BNE	MaSu_-_Masu_NoRestorePointer1
	LDA	MaSu_-_Masu_PointerBackUp1
	STA	MaSu_-_Masu_Pointer1
	LDA	MaSu_-_Masu_PointerBackUp1+1
	STA	MaSu_-_Masu_Pointer1+1
	JMP	MaSu_-_Masu_ReadFirst1
MaSu_-_Masu_NoRestorePointer1
	
	LDY	MaSu_-_Masu_Pointer1	
	STY	MaSu_-_Masu_PointerBackUp1	
	LDY	MaSu_-_Masu_Pointer1+1
	STY	MaSu_-_Masu_PointerBackUp1+1	

	ASL
	TAX
	LDA	MaSu_-_Masu_Data1_CompressedPointerTable,x
	STA	MaSu_-_Masu_Pointer1
	LDA	MaSu_-_Masu_Data1_CompressedPointerTable+1,x
	STA	MaSu_-_Masu_Pointer1+1
	JMP	MaSu_-_Masu_ReadFirst1

MaSu_-_Masu_CommonNote1
	LDA	temp06
	STA	AUDV1
	STA	temp18
	lsr
	...
	CMP	#32
	BCC	MaSu_-_Masu_NotSharedByte1
	...
	STA	MaSu_-_Masu_Duration1
	JMP	MaSu_-_Masu_Skip1

MaSu_-_Masu_NotSharedByte1
...
MaSu_-_Masu_Skip1
	...
	lda	temp02
   	...
   	pha
	jmp	bankSwitchJump
MaSu_-_Masu_Data1_CompressedPointerTable
	BYTE	#0
	BYTE	#0
	BYTE	#<MaSu_-_Masu_Channel1_00010000
	BYTE	#>MaSu_-_Masu_Channel1_00010000
	BYTE	#<MaSu_-_Masu_Channel1_00100000
	BYTE	#>MaSu_-_Masu_Channel1_00100000
	BYTE	#<MaSu_-_Masu_Channel1_00110000
	BYTE	#>MaSu_-_Masu_Channel1_00110000
	BYTE	#<MaSu_-_Masu_Channel1_01000000
	BYTE	#>MaSu_-_Masu_Channel1_01000000
	BYTE	#<MaSu_-_Masu_Channel1_01010000
	BYTE	#>MaSu_-_Masu_Channel1_01010000
	BYTE	#<MaSu_-_Masu_Channel1_01100000
	BYTE	#>MaSu_-_Masu_Channel1_01100000
	BYTE	#<MaSu_-_Masu_Channel1_01110000
	BYTE	#>MaSu_-_Masu_Channel1_01110000
	BYTE	#<MaSu_-_Masu_Channel1_10000000
	BYTE	#>MaSu_-_Masu_Channel1_10000000
	BYTE	#<MaSu_-_Masu_Channel1_10010000
	BYTE	#>MaSu_-_Masu_Channel1_10010000
	BYTE	#<MaSu_-_Masu_Channel1_10100000
	BYTE	#>MaSu_-_Masu_Channel1_10100000
	BYTE	#<MaSu_-_Masu_Channel1_10110000
	BYTE	#>MaSu_-_Masu_Channel1_10110000
	BYTE	#<MaSu_-_Masu_Channel1_11000000
	BYTE	#>MaSu_-_Masu_Channel1_11000000
	BYTE	#<MaSu_-_Masu_Channel1_11010000
	BYTE	#>MaSu_-_Masu_Channel1_11010000

MaSu_-_Masu_Channel1_00010000
	BYTE	#%11001000
	BYTE	#%01011010
	BYTE	#%01110011
	BYTE	#%00010100
...
MaSu_-_Masu_Channel1_00100000
	BYTE	#%11001000
	BYTE	#%01011010
	BYTE	#%11100000

MaSu_-_Masu_Channel1_00110000
	BYTE	#%01110011
	BYTE	#%00010100
	BYTE	#%00010000
	BYTE	#%11100000

MaSu_-_Masu_Channel1_01000000
	BYTE	#%11001000
	BYTE	#%01011111
	BYTE	#%11100000

MaSu_-_Masu_Channel1_01010000
	BYTE	#%11001000
	BYTE	#%01010111
	BYTE	#%11100000

MaSu_-_Masu_Channel1_01100000
	BYTE	#%11001000
	BYTE	#%01010100
	BYTE	#%11100000

MaSu_-_Masu_Channel1_01110000
	BYTE	#%11001000
	BYTE	#%01010011
	BYTE	#%11100000

MaSu_-_Masu_Channel1_10000000
	BYTE	#%01110011
	BYTE	#%00010100
	BYTE	#%00001111
	BYTE	#%11100000

MaSu_-_Masu_Channel1_10010000
	BYTE	#%11001000
	BYTE	#%01010101
	BYTE	#%11100000

MaSu_-_Masu_Channel1_10100000
	BYTE	#%11001001
	BYTE	#%01010100
	BYTE	#%11100000

MaSu_-_Masu_Channel1_10110000
	BYTE	#%11001000
	BYTE	#%01011000
	BYTE	#%11100000

MaSu_-_Masu_Channel1_11000000
	BYTE	#%01110011
	BYTE	#%00010110
	BYTE	#%00010000
	BYTE	#%11100000

MaSu_-_Masu_Channel1_11010000
	BYTE	#%11001001
	BYTE	#%01010011
	BYTE	#%11100000
