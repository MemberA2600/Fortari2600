...
class LoadingScreen():
    ...
    def __init__(self, size, super):
        ...
        self.__Img = ImageTk.PhotoImage(Image.open("others/test.jpg").resize((self.__w_Size,self.__h_Size)))
