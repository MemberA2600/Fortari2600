...
Flimbo_-_Quest_Pointer0 = $e2
Flimbo_-_Quest_Duration0 = $e4
Flimbo_-_Quest_Pointer1 = $e5
Flimbo_-_Quest_Duration1 = $e7
Flimbo_-_Quest_PointerBackUp0 = $e8
Flimbo_-_Quest_PointerBackUp1 = $ea


Flimbo_-_Quest_Init
	LDA	#1
	STA	Flimbo_-_Quest_Duration0
	STA	Flimbo_-_Quest_Duration1

	LDA	#<Flimbo_-_Quest_Data0
	STA	Flimbo_-_Quest_Pointer0
	LDA	#>Flimbo_-_Quest_Data0
	STA	Flimbo_-_Quest_Pointer0+1

	LDA	#<Flimbo_-_Quest_Data1
	STA	Flimbo_-_Quest_Pointer1
	LDA	#>Flimbo_-_Quest_Data1
	STA	Flimbo_-_Quest_Pointer1+1
...
Flimbo_-_Quest_Move_text

	LDA	#TextEnd 
	CMP	#0
	BEQ	Flimbo_-_Quest_Move_Ended

	LDA	counter
	AND	#%00011111
	CMP	#%00011111

	BNE	Flimbo_-_Quest_Move_Ended

	LDA	TextDir
	CMP	#0
	BNE	Flimbo_-_Quest_Text_Reversed

	LDA	TextPoz
	CMP	#TextEnd
	BCC	Flimbo_-_Quest_INCR

	LDA	#1
	STA	TextDir
	JMP	Flimbo_-_Quest_DECR	
Flimbo_-_Quest_INCR
	INC	TextPoz
	JMP	Flimbo_-_Quest_Move_Ended

Flimbo_-_Quest_Text_Reversed
	LDA	TextPoz
	CMP	#0
	BNE	Flimbo_-_Quest_DECR
	STA	TextDir
	JMP	Flimbo_-_Quest_INCR
Flimbo_-_Quest_DECR
	DEC	TextPoz
Flimbo_-_Quest_Move_Ended

	LDY	TextPoz
	LDX	#255

Flimbo_-_Quest_Text_Create_Loop
	INX
	CPX	#12
	BEQ	Flimbo_-_Quest_Text_Create_End

	LDA	Flimbo_-_Quest_ReallyNiceText,y
	STA	Letter01,x
	INY
	JMP	Flimbo_-_Quest_Text_Create_Loop

Flimbo_-_Quest_Text_Create_End
	LDA	#2
	asl
	...
	lda	#<(Flimbo_-_Quest_JumpBack-1)
	sta	temp01
   	lda	#>(Flimbo_-_Quest_JumpBack-1)
	sta	temp02

	lda	#>(Flimbo_-_Quest_Driver0-1)
   	pha
   	lda	#<(Flimbo_-_Quest_Driver0-1)
   	pha
   	pha
...
Flimbo_-_QuestPrepareForDarkness
	LDA	TextBackColor	
	STA	WSYNC
	STA	HMOVE		; 3	
	STA	COLUBK		; 3 (6)
...
Flimbo_-_QuestFillerLine1
	LDA	counter	
	AND	#%00000010
	CMP	#%00000010
	BEQ	Flimbo_-_QuestCalculateDataStart
	STA	WSYNC
	STA	WSYNC

Flimbo_-_QuestCalculateDataStart
	STA	WSYNC
	LDX	#0
Flimbo_-_QuestResetGRP
	STX	GRP0
	STX	GRP1
...
Flimbo_-_QuestOddLine
	...
	JMP	Flimbo_-_QuestThisLineIsCalculated	
Flimbo_-_QuestEvenLine
	LDA	Letter02
	TAX
	LDA	Bank25Table,x		; Got the starting address
	CLC
...
Flimbo_-_QuestThisLineIsCalculated	
	LDA	TextColor
	ADC	Bank2Colors,y
	STA	COLUP0
	STA	COLUP1
	...
	BIT	temp08
	BPL	Flimbo_-_QuestNoReColor
	STA	COLUPF
Flimbo_-_QuestNoReColor
	...
	DEC	temp02		; 5
	LDY	temp02		; 3
	BMI	Flimbo_-_QuestFillerLine2	; 2 
	JMP	Flimbo_-_QuestCalculateDataStart   ; 3

Flimbo_-_QuestFillerLine2
	LDA	#0
	STA	GRP0
	STA	GRP1
	STA 	ENABL		
	...
	AND	#%00000010
	CMP	#%00000010
	BNE	Flimbo_-_QuestReset
	STA	WSYNC
	STA	WSYNC

Flimbo_-_QuestReset
Flimbo_-_Quest_Visuals
...
MusicIndicator8 = $ce
	...
	AND	#%00000011
	CMP	#%00000011
	BEQ	Flimbo_-_Quest_Visuals_DECR
	
	_sleep	34
	sleep	3
	JMP	Flimbo_-_Quest_Visuals_NoLSR

Flimbo_-_Quest_Visuals_DECR
	LSR	MusicIndicator1
	LSR	MusicIndicator2
	LSR	MusicIndicator3
	LSR	MusicIndicator4
...
*
	...
	LDA	Flimbo_-_Quest_Visuals_Data_Pointers,y
	CMP	#0
	BEQ	Flimbo_-_Quest_Visuals_NoChangeChannel0
	...
	BCC	Flimbo_-_Quest_Visuals_NoChangeChannel0
	STA	MusicIndicator1,x

Flimbo_-_Quest_Visuals_NoChangeChannel0
	STA	WSYNC
	...
	LDA	Flimbo_-_Quest_Visuals_Data_Pointers,y
	CMP	#0
	BEQ	Flimbo_-_Quest_Visuals_NoChangeChannel1
	...
	LDA	temp03
	CMP	MusicIndicator1,x
	BCC	Flimbo_-_Quest_Visuals_NoChangeChannel1
	STA	MusicIndicator1,x

Flimbo_-_Quest_Visuals_NoChangeChannel1
	JMP	Flimbo_-_Quest_Visuals_Display

Flimbo_-_Quest_Visuals_Data

Flimbo_-_Quest_Visuals_Data_Pointers
	BYTE	#0
	BYTE	#0				; 0
	BYTE	#<Flimbo_-_Quest_Visuals_Data_Channel_1
	BYTE	#>Flimbo_-_Quest_Visuals_Data_Channel_1	; 1
	BYTE	#<Flimbo_-_Quest_Visuals_Data_Channel_6
	BYTE	#>Flimbo_-_Quest_Visuals_Data_Channel_6	; 2
	BYTE	#<Flimbo_-_Quest_Visuals_Data_Channel_6
	BYTE	#>Flimbo_-_Quest_Visuals_Data_Channel_6	; 3	
	BYTE	#<Flimbo_-_Quest_Visuals_Data_Channel_4
	BYTE	#>Flimbo_-_Quest_Visuals_Data_Channel_4	; 4
	BYTE	#<Flimbo_-_Quest_Visuals_Data_Channel_6
	BYTE	#>Flimbo_-_Quest_Visuals_Data_Channel_6	; 6
	BYTE	#<Flimbo_-_Quest_Visuals_Data_Channel_6
	BYTE	#>Flimbo_-_Quest_Visuals_Data_Channel_6	; 6
	BYTE	#<Flimbo_-_Quest_Visuals_Data_Channel_6
	BYTE	#>Flimbo_-_Quest_Visuals_Data_Channel_6	; 7
	BYTE	#<Flimbo_-_Quest_Visuals_Data_Channel_6
	BYTE	#>Flimbo_-_Quest_Visuals_Data_Channel_6	; 8
	BYTE	#<Flimbo_-_Quest_Visuals_Data_Channel_6
	BYTE	#>Flimbo_-_Quest_Visuals_Data_Channel_6	; 9
	BYTE	#<Flimbo_-_Quest_Visuals_Data_Channel_6
	BYTE	#>Flimbo_-_Quest_Visuals_Data_Channel_6	; 10
	BYTE	#<Flimbo_-_Quest_Visuals_Data_Channel_6
	BYTE	#>Flimbo_-_Quest_Visuals_Data_Channel_6	; 11
	BYTE	#<Flimbo_-_Quest_Visuals_Data_Channel_12
	BYTE	#>Flimbo_-_Quest_Visuals_Data_Channel_12	; 12
	BYTE	#<Flimbo_-_Quest_Visuals_Data_Channel_6
	BYTE	#>Flimbo_-_Quest_Visuals_Data_Channel_6	; 13
	BYTE	#<Flimbo_-_Quest_Visuals_Data_Channel_6
	BYTE	#>Flimbo_-_Quest_Visuals_Data_Channel_6	; 14
	BYTE	#<Flimbo_-_Quest_Visuals_Data_Channel_6
	BYTE	#>Flimbo_-_Quest_Visuals_Data_Channel_6	; 15

Flimbo_-_Quest_Visuals_Data_Channel_1
	BYTE	#0
	BYTE	#2
	BYTE	#4
	BYTE	#5
	...
	BYTE	#7
	BYTE	#7
Flimbo_-_Quest_Visuals_Data_Channel_4
	BYTE	#0
	BYTE	#0
	BYTE	#0
	BYTE	#0
	...
	BYTE	#5
	BYTE	#5
Flimbo_-_Quest_Visuals_Data_Channel_6
	BYTE	#2
	BYTE	#5
	BYTE	#6
	BYTE	#6
	...
	BYTE	#7
	BYTE	#7
Flimbo_-_Quest_Visuals_Data_Channel_12
	BYTE	#0
	BYTE	#0
	BYTE	#0
	BYTE	#0
...
Flimbo_-_Quest_Visuals_Data_Bars
	BYTE	#%00000000
	BYTE	#%10000000
	BYTE	#%11000000
	BYTE	#%11100000
...
Flimbo_-_Quest_Visuals_Data_Barcolors
	BYTE	#$18
	BYTE	#$16
	BYTE	#$14
	BYTE	#$38
	...
	align	256
Flimbo_-_Quest_Visuals_Display
	LDX	#0
Flimbo_-_Quest_Visuals_LineLoop
	STA	WSYNC	; 76
	LDA	MusicIndicator1,x		; 5
	lsr					; 2 (7)
	TAY					; 2 (9)
	STA	temp04				; 3 (12)
	LDA	Flimbo_-_Quest_Visuals_Data_Bars,y	; 5 (17)
	STA	PF2				; 3 (20)
	...
	CLC					; 2 (31)
	ADC 	Flimbo_-_Quest_Visuals_Data_Barcolors,y	; 5 (36)
	STA	COLUPF				; 3 (39)
	STA	temp03				; 3 (42)

	LDY	#3	; This is the line num!
Flimbo_-_Quest_Visuals_LineFiller
	STA	WSYNC
	DEC 	temp03
	...
	AND	#%00001111
	CMP	#$04
	BCC	Flimbo_-_Quest_Visuals_NoColorDECR
	DEC	temp03
Flimbo_-_Quest_Visuals_NoColorDECR
	LDA	temp03

	STA	COLUPF

	DEY
	BPL	Flimbo_-_Quest_Visuals_LineFiller
	STA	WSYNC
	LDA	frameColor
	STA	COLUPF
	...
	INX	
	CPX	#8
	BNE	Flimbo_-_Quest_Visuals_LineLoop

Flimbo_-_Quest_Visuals_DisplayEnded
	LDA	#0
	STA	ENAM0
	STA	HMCLR
...
***************************
	Bank 3
	fill	256
Flimbo_-_Quest_Driver0
	DEC	Flimbo_-_Quest_Duration0
	LDA	Flimbo_-_Quest_Duration0
	CMP	#0
	BNE	Flimbo_-_Quest_Skip0

Flimbo_-_Quest_ReadFirst0
	LDX	#Flimbo_-_Quest_Pointer0
	LDA	($00,x)
	INC	0,x
	BNE	*+4
	INC	1,x
	...
	STA	temp16
	STA	temp17
	JMP	Flimbo_-_Quest_NotSharedByte0

Flimbo_-_Quest_if2400
	CMP	#240
	BNE	Flimbo_-_Quest_NoRestart0

Flimbo_-_Quest_Restart0
	LDA	#<Flimbo_-_Quest_Data0
	STA	Flimbo_-_Quest_Pointer0
	LDA	#>Flimbo_-_Quest_Data0
	STA	Flimbo_-_Quest_Pointer0+1

	JMP	Flimbo_-_Quest_ReadFirst0

Flimbo_-_Quest_NoRestart0
	STA	temp06
	AND	#%00001111
	CMP	#0
	BNE	Flimbo_-_Quest_CommonNote0
	LDA	temp06
	lsr
	lsr
	lsr
	lsr
	CMP	#%00001110
	BNE	Flimbo_-_Quest_NoRestorePointer0
	LDA	Flimbo_-_Quest_PointerBackUp0
	STA	Flimbo_-_Quest_Pointer0
	LDA	Flimbo_-_Quest_PointerBackUp0+1
	STA	Flimbo_-_Quest_Pointer0+1
	JMP	Flimbo_-_Quest_ReadFirst0
Flimbo_-_Quest_NoRestorePointer0
	
	LDY	Flimbo_-_Quest_Pointer0	
	STY	Flimbo_-_Quest_PointerBackUp0	
	LDY	Flimbo_-_Quest_Pointer0+1
	STY	Flimbo_-_Quest_PointerBackUp0+1	

	ASL
	TAX
	LDA	Flimbo_-_Quest_Data0_CompressedPointerTable,x
	STA	Flimbo_-_Quest_Pointer0
	LDA	Flimbo_-_Quest_Data0_CompressedPointerTable+1,x
	STA	Flimbo_-_Quest_Pointer0+1
	JMP	Flimbo_-_Quest_ReadFirst0

Flimbo_-_Quest_CommonNote0
	LDA	temp06
	STA	AUDV0
	STA	temp16
	lsr
	...
	CMP	#32
	BCC	Flimbo_-_Quest_NotSharedByte0
	...
	STA	Flimbo_-_Quest_Duration0
	JMP	Flimbo_-_Quest_Skip0

Flimbo_-_Quest_NotSharedByte0
...
Flimbo_-_Quest_Skip0
Flimbo_-_Quest_Driver1
	DEC	Flimbo_-_Quest_Duration1
	LDA	Flimbo_-_Quest_Duration1
	CMP	#0
	BNE	Flimbo_-_Quest_Skip1

Flimbo_-_Quest_ReadFirst1
	LDX	#Flimbo_-_Quest_Pointer1
	LDA	($00,x)
	INC	0,x
	BNE	*+4
	INC	1,x
	...
	STA	temp18
	STA	temp19
	JMP	Flimbo_-_Quest_NotSharedByte1

Flimbo_-_Quest_if2401
	CMP	#240
	BNE	Flimbo_-_Quest_NoRestart1

Flimbo_-_Quest_Restart1
	LDA	#<Flimbo_-_Quest_Data1
	STA	Flimbo_-_Quest_Pointer1
	LDA	#>Flimbo_-_Quest_Data1
	STA	Flimbo_-_Quest_Pointer1+1

	JMP	Flimbo_-_Quest_ReadFirst1

Flimbo_-_Quest_NoRestart1
	STA	temp06
	AND	#%00001111
	CMP	#0
	BNE	Flimbo_-_Quest_CommonNote1
	LDA	temp06
	lsr
	lsr
	lsr
	lsr
	CMP	#%00001110
	BNE	Flimbo_-_Quest_NoRestorePointer1
	LDA	Flimbo_-_Quest_PointerBackUp1
	STA	Flimbo_-_Quest_Pointer1
	LDA	Flimbo_-_Quest_PointerBackUp1+1
	STA	Flimbo_-_Quest_Pointer1+1
	JMP	Flimbo_-_Quest_ReadFirst1
Flimbo_-_Quest_NoRestorePointer1
	
	LDY	Flimbo_-_Quest_Pointer1	
	STY	Flimbo_-_Quest_PointerBackUp1	
	LDY	Flimbo_-_Quest_Pointer1+1
	STY	Flimbo_-_Quest_PointerBackUp1+1	

	ASL
	TAX
	LDA	Flimbo_-_Quest_Data1_CompressedPointerTable,x
	STA	Flimbo_-_Quest_Pointer1
	LDA	Flimbo_-_Quest_Data1_CompressedPointerTable+1,x
	STA	Flimbo_-_Quest_Pointer1+1
	JMP	Flimbo_-_Quest_ReadFirst1

Flimbo_-_Quest_CommonNote1
	LDA	temp06
	STA	AUDV1
	STA	temp18
	lsr
	...
	CMP	#32
	BCC	Flimbo_-_Quest_NotSharedByte1
	...
	STA	Flimbo_-_Quest_Duration1
	JMP	Flimbo_-_Quest_Skip1

Flimbo_-_Quest_NotSharedByte1
...
Flimbo_-_Quest_Skip1
	...
	lda	temp02
   	...
   	pha
	jmp	bankSwitchJump
Flimbo_-_Quest_Data0_CompressedPointerTable
	BYTE	#0
	BYTE	#0
	BYTE	#<Flimbo_-_Quest_Channel0_00010000
	BYTE	#>Flimbo_-_Quest_Channel0_00010000
	BYTE	#<Flimbo_-_Quest_Channel0_00100000
	BYTE	#>Flimbo_-_Quest_Channel0_00100000
	BYTE	#<Flimbo_-_Quest_Channel0_00110000
	BYTE	#>Flimbo_-_Quest_Channel0_00110000
	BYTE	#<Flimbo_-_Quest_Channel0_01000000
	BYTE	#>Flimbo_-_Quest_Channel0_01000000
	BYTE	#<Flimbo_-_Quest_Channel0_01010000
	BYTE	#>Flimbo_-_Quest_Channel0_01010000
	BYTE	#<Flimbo_-_Quest_Channel0_01100000
	BYTE	#>Flimbo_-_Quest_Channel0_01100000
	BYTE	#<Flimbo_-_Quest_Channel0_01110000
	BYTE	#>Flimbo_-_Quest_Channel0_01110000
	BYTE	#<Flimbo_-_Quest_Channel0_10000000
	BYTE	#>Flimbo_-_Quest_Channel0_10000000
	BYTE	#<Flimbo_-_Quest_Channel0_10010000
	BYTE	#>Flimbo_-_Quest_Channel0_10010000
	BYTE	#<Flimbo_-_Quest_Channel0_10100000
	BYTE	#>Flimbo_-_Quest_Channel0_10100000
Flimbo_-_Quest_Channel0_00010000
	BYTE	#%11001010
	BYTE	#%00101111
	BYTE	#%11100000

Flimbo_-_Quest_Channel0_00100000
	BYTE	#%11001010
	BYTE	#%00100111
	BYTE	#%11100000

Flimbo_-_Quest_Channel0_00110000
	BYTE	#%11001010
	BYTE	#%01001011
	BYTE	#%11100000

Flimbo_-_Quest_Channel0_01000000
	BYTE	#%11001010
	BYTE	#%00101011
	BYTE	#%11100000

Flimbo_-_Quest_Channel0_01010000
	BYTE	#%00000000
	BYTE	#%00000010
	BYTE	#%11100000

Flimbo_-_Quest_Channel0_01100000
	BYTE	#%11001010
	BYTE	#%00110100
	BYTE	#%11100000

Flimbo_-_Quest_Channel0_01110000
	BYTE	#%01001010
	BYTE	#%00111011
	BYTE	#%11100000

Flimbo_-_Quest_Channel0_10000000
	BYTE	#%01001010
	BYTE	#%01011111
	BYTE	#%11100000

Flimbo_-_Quest_Channel0_10010000
	BYTE	#%01001010
	BYTE	#%01010010
	BYTE	#%11100000

Flimbo_-_Quest_Channel0_10100000
	BYTE	#%01001010
	BYTE	#%01011111
	BYTE	#%11100000
Flimbo_-_Quest_Data0
	BYTE	#%01001010
	BYTE	#%01011011
	BYTE	#%11001010
	BYTE	#%00111000
...
Flimbo_-_Quest_Data1_CompressedPointerTable
	BYTE	#0
	BYTE	#0
	BYTE	#<Flimbo_-_Quest_Channel1_00010000
	BYTE	#>Flimbo_-_Quest_Channel1_00010000
	BYTE	#<Flimbo_-_Quest_Channel1_00100000
	BYTE	#>Flimbo_-_Quest_Channel1_00100000
	BYTE	#<Flimbo_-_Quest_Channel1_00110000
	BYTE	#>Flimbo_-_Quest_Channel1_00110000
	BYTE	#<Flimbo_-_Quest_Channel1_01000000
	BYTE	#>Flimbo_-_Quest_Channel1_01000000
	BYTE	#<Flimbo_-_Quest_Channel1_01010000
	BYTE	#>Flimbo_-_Quest_Channel1_01010000
	BYTE	#<Flimbo_-_Quest_Channel1_01100000
	BYTE	#>Flimbo_-_Quest_Channel1_01100000
	BYTE	#<Flimbo_-_Quest_Channel1_01110000
	BYTE	#>Flimbo_-_Quest_Channel1_01110000
	BYTE	#<Flimbo_-_Quest_Channel1_10000000
	BYTE	#>Flimbo_-_Quest_Channel1_10000000
	BYTE	#<Flimbo_-_Quest_Channel1_10010000
	BYTE	#>Flimbo_-_Quest_Channel1_10010000
	BYTE	#<Flimbo_-_Quest_Channel1_10100000
	BYTE	#>Flimbo_-_Quest_Channel1_10100000
Flimbo_-_Quest_Channel1_00010000
	BYTE	#%00000000
	BYTE	#%00000010
	BYTE	#%11100000

Flimbo_-_Quest_Channel1_00100000
	BYTE	#%11001010
	BYTE	#%00111000
	BYTE	#%11100000

Flimbo_-_Quest_Channel1_00110000
	BYTE	#%00000000
	BYTE	#%00000100
	BYTE	#%11100000

Flimbo_-_Quest_Channel1_01000000
	BYTE	#%00000000
	BYTE	#%00000011
	BYTE	#%11100000

Flimbo_-_Quest_Channel1_01010000
	BYTE	#%00000000
	BYTE	#%00000101
	BYTE	#%11100000

Flimbo_-_Quest_Channel1_01100000
	BYTE	#%01110100
	BYTE	#%10010010
	BYTE	#%11100000

Flimbo_-_Quest_Channel1_01110000
	BYTE	#%00010100
	BYTE	#%01010011
	BYTE	#%11100000

Flimbo_-_Quest_Channel1_10000000
	BYTE	#%01110100
	BYTE	#%10001111
	BYTE	#%11100000

Flimbo_-_Quest_Channel1_10010000
	BYTE	#%00010100
	BYTE	#%01010000
	BYTE	#%11100000

Flimbo_-_Quest_Channel1_10100000
	BYTE	#%00010100
	BYTE	#%00110011
	BYTE	#%11100000
Flimbo_-_Quest_Data1
	BYTE	#%00010000	; This was changed
****	BYTE	#%00000000
****	BYTE	#%00000010
****
