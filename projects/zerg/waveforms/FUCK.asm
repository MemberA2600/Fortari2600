...
FUCK_Constant      = 8
FUCK_NTSC_Vblank   = 37
FUCK_NTSC_Overscan = 30
FUCK_PAL_Vblank    = 67
FUCK_PAL_Overscan  = 50


FUCK_EOF_byte = %00000000
...
FUCK_LoadSample
	...
	DEC	temp13			; 5
	LDA	temp12			; 3
	JMP	FUCK_CounterDone ; 3

FUCK_LoadNew
	LDX	#temp10			; 2
	LDA	($00,x)			; 6 
	CMP	#FUCK_EOF_byte	; 2 
	BEQ	FUCK_FinishHim	; 2 
	INC	0,x			; 6
	BNE	*+4			; 2 
	INC	1,x 			; 6 

	CMP	#16			; 2
	BCS	FUCK_NoCounter	; 2
...
FUCK_CounterDone
	...
	TYA				; 2
	STA	AUDV0			; 3 (5)
	JMP	FUCK_LoadSample	; 3 (8)
	
FUCK_FinishHim
	LDX	#FUCK_Constant	; 2 (14)
...
FUCK_DebugLoop2
	...
	LDA	#2
	STA	VBLANK
	LDY	#FUCK_NTSC_Overscan
FUCK_DebugLoop3
	STA	WSYNC
	DEY
	BNE	FUCK_DebugLoop3

	JMP	FUCK_DebugScreen
